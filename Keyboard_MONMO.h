...
const UnicodeLookup kbdmonmo[] PROGMEM = 
{
  ...
  {0x1838, 0x1a | MOD_SHIFT},	// Mongolian Letter Wa
  ...
  {0x1842, 0x06 | MOD_SHIFT},	// Mongolian Letter Chi
  ...
  {0x1834, 0x14},	// Mongolian Letter Cha
  {0x1823, 0x1a},	// Mongolian Letter O
  ...
  {0x1801, 0x31},	// Mongolian Ellipsis
  ...
  {0x183c, 0x06},	// Mongolian Letter Tsa
...
const DeadkeyLookup kbdmonmo_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_MONMO(kbdmonmo, sizeof kbdmonmo / sizeof kbdmonmo[0], kbdmonmo_deadkeys, sizeof kbdmonmo_deadkeys / sizeof kbdmonmo_deadkeys[0]);
