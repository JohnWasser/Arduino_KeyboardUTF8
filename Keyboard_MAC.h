...
const UnicodeLookup kbdmac[] PROGMEM = 
{
  ...
  {0x0402, 0x2f | MOD_ALTGR},	// Cyrillic Capital Letter Dje (Serbocroatian)
  {0x0452, 0x30 | MOD_ALTGR},	// Cyrillic Small Letter Dje (Serbocroatian)
  {0x005b, 0x09 | MOD_ALTGR},	// Left Square Bracket
  {0x005d, 0x0a | MOD_ALTGR},	// Right Square Bracket
  {0x040b, 0x33 | MOD_ALTGR},	// Cyrillic Capital Letter Tshe (Serbocroatian)
  {0x045b, 0x34 | MOD_ALTGR},	// Cyrillic Small Letter Tshe (Serbocroatian)
  ...
  {0x2019, 0x21 | MOD_SHIFT},	// Right Single Quotation Mark
  {0x0025, 0x22 | MOD_SHIFT},	// Percent Sign
  {0x2018, 0x23 | MOD_SHIFT},	// Left Single Quotation Mark
  ...
  {0x0401, 0x64 | MOD_SHIFT},	// Cyrillic Capital Letter Io
  ...
  {0x0451, 0x64},	// Cyrillic Small Letter Io
...
KeyboardUTF8 Keyboard_MAC(kbdmac, sizeof kbdmac / sizeof kbdmac[0], kbdmac_deadkeys, sizeof kbdmac_deadkeys / sizeof kbdmac_deadkeys[0]);
