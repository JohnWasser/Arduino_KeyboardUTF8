...
const UnicodeLookup kbdrost[] PROGMEM = 
{
  ...
  {0x00ab, 0x36 | (MOD_SHIFT | MOD_ALTGR)},	// Left-Pointing Double Angle Quotation Mark *
  {0x00bb, 0x37 | (MOD_SHIFT | MOD_ALTGR)},	// Right-Pointing Double Angle Quotation Mark *
  ...
  {0x201d, 0x35 | MOD_SHIFT},	// Right Double Quotation Mark
  ...
  {0x0218, 0x33 | MOD_SHIFT},	// Latin Capital Letter S With Comma Below *
  {0x021a, 0x34 | MOD_SHIFT},	// Latin Capital Letter T With Comma Below *
  ...
  {0x0219, 0x33},	// Latin Small Letter S With Comma Below *
  {0x021b, 0x34},	// Latin Small Letter T With Comma Below *
...
KeyboardUTF8 Keyboard_ROST(kbdrost, sizeof kbdrost / sizeof kbdrost[0], kbdrost_deadkeys, sizeof kbdrost_deadkeys / sizeof kbdrost_deadkeys[0]);
