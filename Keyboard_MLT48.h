...
const UnicodeLookup kbdmlt48[] PROGMEM = 
{
  ...
  {0x00ac, 0x35 | (MOD_SHIFT | MOD_ALTGR)},	// Not Sign
  {0x00c8, 0x08 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter E With Grave
  {0x00d9, 0xa0 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter U With Grave
  {0x00cc, 0x0c | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter I With Grave
  {0x00d2, 0x12 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter O With Grave
  {0x007b, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Left Curly Bracket
  {0x007d, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Right Curly Bracket
  {0x00c0, 0x04 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter A With Grave
  {0x007c, 0x64 | (MOD_SHIFT | MOD_ALTGR)},	// Vertical Line
  {0x0060, 0x35 | MOD_ALTGR},	// Grave Accent
  {0x00a3, 0x20 | MOD_ALTGR},	// Pound Sign
  {0x00e8, 0x08 | MOD_ALTGR},	// Latin Small Letter E With Grave
  {0x00f9, 0xa0 | MOD_ALTGR},	// Latin Small Letter U With Grave
  {0x00ec, 0x0c | MOD_ALTGR},	// Latin Small Letter I With Grave
  {0x00f2, 0x12 | MOD_ALTGR},	// Latin Small Letter O With Grave
  {0x005b, 0x2f | MOD_ALTGR},	// Left Square Bracket
  {0x005d, 0x30 | MOD_ALTGR},	// Right Square Bracket
  {0x00e0, 0x04 | MOD_ALTGR},	// Latin Small Letter A With Grave
  {0x005c, 0x64 | MOD_ALTGR},	// Reverse Solidus
  {0x010a, 0x35 | MOD_SHIFT},	// Latin Capital Letter C With Dot Above
  {0x0021, 0x1e | MOD_SHIFT},	// Exclamation Mark
  {0x0022, 0x1f | MOD_SHIFT},	// Quotation Mark
  {0x20ac, 0x20 | MOD_SHIFT},	// Euro Sign
  ...
  {0x0120, 0x2f | MOD_SHIFT},	// Latin Capital Letter G With Dot Above
  {0x0126, 0x30 | MOD_SHIFT},	// Latin Capital Letter H With Stroke
  {0x007e, 0x31 | MOD_SHIFT},	// Tilde
  ...
  {0x017b, 0x64 | MOD_SHIFT},	// Latin Capital Letter Z With Dot Above
  ...
  {0x010b, 0x35},	// Latin Small Letter C With Dot Above
  ...
  {0x0121, 0x2f},	// Latin Small Letter G With Dot Above
  {0x0127, 0x30},	// Latin Small Letter H With Stroke
  {0x0023, 0x31},	// Number Sign
  ...
  {0x017c, 0x64},	// Latin Small Letter Z With Dot Above
...
KeyboardUTF8 Keyboard_MLT48(kbdmlt48, sizeof kbdmlt48 / sizeof kbdmlt48[0], kbdmlt48_deadkeys, sizeof kbdmlt48_deadkeys / sizeof kbdmlt48_deadkeys[0]);
