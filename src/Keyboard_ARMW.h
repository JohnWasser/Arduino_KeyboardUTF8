...
const UnicodeLookup kbdarmw[] PROGMEM = 
{
  ...
  {0x054e, 0x1a | MOD_SHIFT},	// Armenian Capital Letter Vew
  {0x0537, 0x08 | MOD_SHIFT},	// Armenian Capital Letter Eh
  {0x0550, 0x15 | MOD_SHIFT},	// Armenian Capital Letter Reh
  {0x0534, 0x17 | MOD_SHIFT},	// Armenian Capital Letter Da
  ...
  {0x0532, 0x13 | MOD_SHIFT},	// Armenian Capital Letter Ben
  ...
  {0x054f, 0x07 | MOD_SHIFT},	// Armenian Capital Letter Tiwn
  {0x0556, 0x09 | MOD_SHIFT},	// Armenian Capital Letter Feh
  {0x053f, 0x0a | MOD_SHIFT},	// Armenian Capital Letter Ken
  {0x0540, 0x0b | MOD_SHIFT},	// Armenian Capital Letter Ho
  {0x0543, 0x0d | MOD_SHIFT},	// Armenian Capital Letter Cheh
  {0x0554, 0x0e | MOD_SHIFT},	// Armenian Capital Letter Keh
  ...
  {0x0552, 0x19 | MOD_SHIFT},	// Armenian Capital Letter Yiwn
  {0x054a, 0x05 | MOD_SHIFT},	// Armenian Capital Letter Peh
  ...
  {0x057e, 0x1a},	// Armenian Small Letter Vew
  {0x0567, 0x08},	// Armenian Small Letter Eh
  {0x0580, 0x15},	// Armenian Small Letter Reh
  {0x0564, 0x17},	// Armenian Small Letter Da
  ...
  {0x0562, 0x13},	// Armenian Small Letter Ben
  ...
  {0x057f, 0x07},	// Armenian Small Letter Tiwn
  {0x0586, 0x09},	// Armenian Small Letter Feh
  {0x056f, 0x0a},	// Armenian Small Letter Ken
  {0x0570, 0x0b},	// Armenian Small Letter Ho
  {0x0573, 0x0d},	// Armenian Small Letter Cheh
  {0x0584, 0x0e},	// Armenian Small Letter Keh
  ...
  {0x0582, 0x19},	// Armenian Small Letter Yiwn
  {0x057a, 0x05},	// Armenian Small Letter Peh
...
KeyboardUTF8 Keyboard_ARMW(kbdarmw, sizeof kbdarmw / sizeof kbdarmw[0], kbdarmw_deadkeys, sizeof kbdarmw_deadkeys / sizeof kbdarmw_deadkeys[0]);
