...
const UnicodeLookup kbdazel[] PROGMEM = 
{
  ...
  {0x0130, 0x0c | MOD_SHIFT},	// Latin Capital Letter I With Dot Above
  {0x004f, 0x12 | MOD_SHIFT},	// Latin Capital Letter O
  {0x0050, 0x13 | MOD_SHIFT},	// Latin Capital Letter P
  {0x00d6, 0x2f | MOD_SHIFT},	// Latin Capital Letter O With Diaeresis
  {0x011e, 0x30 | MOD_SHIFT},	// Latin Capital Letter G With Breve
  ...
  {0x0049, 0x33 | MOD_SHIFT},	// Latin Capital Letter I
  {0x018f, 0x34 | MOD_SHIFT},	// Latin Capital Letter Schwa
  ...
  {0x00c7, 0x36 | MOD_SHIFT},	// Latin Capital Letter C With Cedilla
  {0x015e, 0x37 | MOD_SHIFT},	// Latin Capital Letter S With Cedilla *
  ...
  {0x00f6, 0x2f},	// Latin Small Letter O With Diaeresis
  {0x011f, 0x30},	// Latin Small Letter G With Breve
  ...
  {0x0131, 0x33},	// Latin Small Letter Dotless I
  {0x0259, 0x34},	// Latin Small Letter Schwa
  ...
  {0x00e7, 0x36},	// Latin Small Letter C With Cedilla
  {0x015f, 0x37},	// Latin Small Letter S With Cedilla *
  {0x002e, 0x38},	// Full Stop
};

const DeadkeyLookup kbdazel_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_AZEL(kbdazel, sizeof kbdazel / sizeof kbdazel[0], kbdazel_deadkeys, sizeof kbdazel_deadkeys / sizeof kbdazel_deadkeys[0]);
