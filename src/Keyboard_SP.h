...
const UnicodeLookup kbdsp[] PROGMEM = 
{
  ...
  {0x007c, 0x1e | MOD_ALTGR},	// Vertical Line
  ...
  {0x00aa, 0x35 | MOD_SHIFT},	// Feminine Ordinal Indicator
  {0x0021, 0x1e | MOD_SHIFT},	// Exclamation Mark
  {0x0022, 0x1f | MOD_SHIFT},	// Quotation Mark
  {0x00b7, 0x20 | MOD_SHIFT},	// Middle Dot
  ...
  {0x00bf, 0x2e | MOD_SHIFT},	// Inverted Question Mark
  ...
  {0x00c7, 0x28 | MOD_SHIFT},	// Latin Capital Letter C With Cedilla
  ...
  {0x00ba, 0x35},	// Masculine Ordinal Indicator
  ...
  {0x00a1, 0x2e},	// Inverted Exclamation Mark
  ...
  {0x00e7, 0x28},	// Latin Small Letter C With Cedilla
...
const DeadkeyLookup kbdsp_deadkeys[] PROGMEM = 
{
  {0x007e, 0x007e, 0x21 | MOD_ALTGR},	// ~  accent
  {0x00e3, 0x0061, 0x21 | MOD_ALTGR},	// ã Small A Tilde
  {0x00c3, 0x0041, 0x21 | MOD_ALTGR},	// Ã Capital A Tilde
  {0x00f1, 0x006e, 0x21 | MOD_ALTGR},	// ñ Small N Tilde
  {0x00d1, 0x004e, 0x21 | MOD_ALTGR},	// Ñ Capital N Tilde
  {0x00f5, 0x006f, 0x21 | MOD_ALTGR},	// õ Small O Tilde
  {0x00d5, 0x004f, 0x21 | MOD_ALTGR},	// Õ Capital O Tilde
  ...
  {0x00a8, 0x00a8, 0x34 | MOD_SHIFT},	// ¨  accent
  {0x00e4, 0x0061, 0x34 | MOD_SHIFT},	// ä Small A Diaeresis
  {0x00c4, 0x0041, 0x34 | MOD_SHIFT},	// Ä Capital A Diaeresis
  {0x00eb, 0x0065, 0x34 | MOD_SHIFT},	// ë Small E Diaeresis
  {0x00cb, 0x0045, 0x34 | MOD_SHIFT},	// Ë Capital E Diaeresis
  {0x00ef, 0x0069, 0x34 | MOD_SHIFT},	// ï Small I Diaeresis
  {0x00cf, 0x0049, 0x34 | MOD_SHIFT},	// Ï Capital I Diaeresis
  {0x00f6, 0x006f, 0x34 | MOD_SHIFT},	// ö Small O Diaeresis
  {0x00d6, 0x004f, 0x34 | MOD_SHIFT},	// Ö Capital O Diaeresis
  {0x00fc, 0x0075, 0x34 | MOD_SHIFT},	// ü Small U Diaeresis
  {0x00dc, 0x0055, 0x34 | MOD_SHIFT},	// Ü Capital U Diaeresis
  {0x00ff, 0x0079, 0x34 | MOD_SHIFT},	// ÿ Small Y Diaeresis
  {0x0060, 0x0060, 0x2f},	// `  accent
  {0x00e0, 0x0061, 0x2f},	// à Small A Grave
  {0x00c0, 0x0041, 0x2f},	// À Capital A Grave
  {0x00e8, 0x0065, 0x2f},	// è Small E Grave
  {0x00c8, 0x0045, 0x2f},	// È Capital E Grave
  {0x00ec, 0x0069, 0x2f},	// ì Small I Grave
  {0x00cc, 0x0049, 0x2f},	// Ì Capital I Grave
  {0x00f2, 0x006f, 0x2f},	// ò Small O Grave
  {0x00d2, 0x004f, 0x2f},	// Ò Capital O Grave
  {0x00f9, 0x0075, 0x2f},	// ù Small U Grave
  {0x00d9, 0x0055, 0x2f},	// Ù Capital U Grave
...
KeyboardUTF8 Keyboard_SP(kbdsp, sizeof kbdsp / sizeof kbdsp[0], kbdsp_deadkeys, sizeof kbdsp_deadkeys / sizeof kbdsp_deadkeys[0]);
