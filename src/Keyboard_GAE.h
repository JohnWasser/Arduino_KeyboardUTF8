...
const UnicodeLookup kbdgae[] PROGMEM = 
{
  ...
  {0x0060, 0x35 | MOD_SHIFT},	// Grave Accent
...
KeyboardUTF8 Keyboard_GAE(kbdgae, sizeof kbdgae / sizeof kbdgae[0], kbdgae_deadkeys, sizeof kbdgae_deadkeys / sizeof kbdgae_deadkeys[0]);
