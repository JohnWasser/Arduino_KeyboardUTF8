...
const DeadkeyLookup kbdsors1_deadkeys[] PROGMEM = 
{
  ...
  {0x0142, 0x006c, 0x2e},	// ł Small L Stroke
  {0x0141, 0x004c, 0x2e},	// Ł Capital L Stroke
...
KeyboardUTF8 Keyboard_SORS1(kbdsors1, sizeof kbdsors1 / sizeof kbdsors1[0], kbdsors1_deadkeys, sizeof kbdsors1_deadkeys / sizeof kbdsors1_deadkeys[0]);
