...
const UnicodeLookup kbdfo[] PROGMEM = 
{
  ...
  {0x00d0, 0x30 | MOD_SHIFT},	// Latin Capital Letter Eth (Icelandic)
  ...
  {0x00f0, 0x30},	// Latin Small Letter Eth (Icelandic)
...
KeyboardUTF8 Keyboard_FO(kbdfo, sizeof kbdfo / sizeof kbdfo[0], kbdfo_deadkeys, sizeof kbdfo_deadkeys / sizeof kbdfo_deadkeys[0]);
