...
const UnicodeLookup kbdvntc[] PROGMEM = 
{
  ...
  {0x002a, 0x25 | (MOD_SHIFT | MOD_ALTGR)},	// <None>
  ...
  {0x002f, 0x38},	// Solidus
  {0x0102, 0x1e | MOD_SHIFT},	// Latin Capital Letter A With Breve
  {0x00c2, 0x1f | MOD_SHIFT},	// Latin Capital Letter A With Circumflex
  {0x00ca, 0x20 | MOD_SHIFT},	// Latin Capital Letter E With Circumflex
  {0x00d4, 0x21 | MOD_SHIFT},	// Latin Capital Letter O With Circumflex
  {0x0300, 0x22},	// Combining Grave Accent (Varia)
  {0x0309, 0x23},	// Combining Hook Above
  {0x0303, 0x24},	// Combining Tilde
  {0x0301, 0x25},	// Combining Acute Accent (Oxia
  {0x0323, 0x26},	// Combining Dot Below
  {0x0110, 0x27 | MOD_SHIFT},	// Latin Capital Letter D With Stroke
  {0x01af, 0x2f | MOD_SHIFT},	// Latin Capital Letter U With Horn
  {0x01a0, 0x30 | MOD_SHIFT},	// Latin Capital Letter O With Horn
  {0x0103, 0x1e},	// Latin Small Letter A With Breve
  {0x00e2, 0x1f},	// Latin Small Letter A With Circumflex
  {0x00ea, 0x20},	// Latin Small Letter E With Circumflex
  {0x00f4, 0x21},	// Latin Small Letter O With Circumflex
  {0x0111, 0x27},	// Latin Small Letter D With Stroke
  {0x20ab, 0x2e},	// Dong Sign
  {0x01b0, 0x2f},	// Latin Small Letter U With Horn
...
KeyboardUTF8 Keyboard_VNTC(kbdvntc, sizeof kbdvntc / sizeof kbdvntc[0], kbdvntc_deadkeys, sizeof kbdvntc_deadkeys / sizeof kbdvntc_deadkeys[0]);
