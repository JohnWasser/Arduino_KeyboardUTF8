...
const DeadkeyLookup kbdycl_deadkeys[] PROGMEM = 
{
  ...
  {0x201a, 0x201a, 0x35},	// ‚  accent
};

KeyboardUTF8 Keyboard_YCL(kbdycl, sizeof kbdycl / sizeof kbdycl[0], kbdycl_deadkeys, sizeof kbdycl_deadkeys / sizeof kbdycl_deadkeys[0]);
