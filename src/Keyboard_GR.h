...
const UnicodeLookup kbdgr[] PROGMEM = 
{
...
const DeadkeyLookup kbdgr_deadkeys[] PROGMEM = 
{
...
KeyboardUTF8 Keyboard_GR(kbdgr, sizeof kbdgr / sizeof kbdgr[0], kbdgr_deadkeys, sizeof kbdgr_deadkeys / sizeof kbdgr_deadkeys[0]);
