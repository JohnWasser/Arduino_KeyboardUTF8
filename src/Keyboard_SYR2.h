...
const UnicodeLookup kbdsyr2[] PROGMEM = 
{
  ...
  {0x0729, 0x14},	// Syriac Letter Qaph
  {0x0718, 0x1a},	// Syriac Letter Waw
  {0x0716, 0x08},	// Syriac Letter Dotless Dalath Rish
  {0x072a, 0x15},	// Syriac Letter Rish
  {0x072c, 0x17},	// Syriac Letter Taw
  {0x071d, 0x1c},	// Syriac Letter Yudh
  {0x071c, 0xa0},	// Syriac Letter Teth Garshuni
  {0x0725, 0x0c},	// Syriac Letter E
  {0x0727, 0x12},	// Syriac Letter Reversed Pe
  {0x0726, 0x13},	// Syriac Letter Pe
  {0x005d, 0x2f},	// Right Square Bracket
  {0x005b, 0x30},	// Left Square Bracket
  {0x0706, 0x64},	// Syriac Colon Skewed Left
  {0x0710, 0x04},	// Syriac Letter Alaph
  {0x0723, 0x16},	// Syriac Letter Semkath
  {0x0715, 0x07},	// Syriac Letter Dalath
  {0x0714, 0x09},	// Syriac Letter Gamal Garshuni
  {0x0713, 0x0a},	// Syriac Letter Gamal
  {0x0717, 0x0b},	// Syriac Letter He
  {0x071b, 0x0d},	// Syriac Letter Teth
  {0x071f, 0x0e},	// Syriac Letter Kaph
  {0x0720, 0x0f},	// Syriac Letter Lamadh
  {0x071a, 0x33},	// Syriac Letter Heth
  {0x071e, 0x34},	// Syriac Letter Yudh He
  {0x0719, 0x1d},	// Syriac Letter Zain
  {0x0728, 0x1b},	// Syriac Letter Sadhe
  {0x0724, 0x06},	// Syriac Letter Final Semkath
  {0x072b, 0x19},	// Syriac Letter Shin
  {0x0712, 0x05},	// Syriac Letter Beth
  {0x0722, 0x11},	// Syriac Letter Nun
  {0x0721, 0x10},	// Syriac Letter Mim
  {0x0700, 0x36},	// Syriac End Of Paragraph
  {0x002e, 0x37},	// Full Stop
  {0x0707, 0x38},	// Syriac Colon Skewed Right
};

const DeadkeyLookup kbdsyr2_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_SYR2(kbdsyr2, sizeof kbdsyr2 / sizeof kbdsyr2[0], kbdsyr2_deadkeys, sizeof kbdsyr2_deadkeys / sizeof kbdsyr2_deadkeys[0]);
