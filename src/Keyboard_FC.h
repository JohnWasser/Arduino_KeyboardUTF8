...
const UnicodeLookup kbdfc[] PROGMEM = 
{
  ...
  {0x00a3, 0x20 | (MOD_SHIFT | MOD_ALTGR)},	// Pound Sign
  {0x00a4, 0x21 | (MOD_SHIFT | MOD_ALTGR)},	// Currency Sign
  {0x00b1, 0x26 | (MOD_SHIFT | MOD_ALTGR)},	// Plus-Minus Sign
  ...
  {0x00de, 0x13 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter Thorn (Icelandic)
  ...
  {0x007c, 0x2d | MOD_ALTGR},	// Vertical Line
  ...
  {0x00fe, 0x13 | MOD_ALTGR},	// Latin Small Letter Thorn (Icelandic)
  {0x00b0, 0x35},	// Degree Sign
  ...
  {0x00aa, 0x09 | MOD_ALTGR},	// Feminine Ordinal Indicator
  ...
  {0x003f, 0x23 | MOD_SHIFT},	// Question Mark
  ...
  {0x00c7, 0x30 | MOD_SHIFT},	// Latin Capital Letter C With Cedilla
  {0x00c0, 0x31 | MOD_SHIFT},	// Latin Capital Letter A With Grave
  ...
  {0x00c8, 0x34 | MOD_SHIFT},	// Latin Capital Letter E With Grave
  {0x00d9, 0x64 | MOD_SHIFT},	// Latin Capital Letter U With Grave
  ...
  {0x0027, 0x36 | MOD_SHIFT},	// Apostrophe
  {0x002e, 0x37},	// Full Stop
  {0x00c9, 0x38 | MOD_SHIFT},	// Latin Capital Letter E With Acute
  ...
  {0x00e7, 0x30},	// Latin Small Letter C With Cedilla
  {0x00e0, 0x31},	// Latin Small Letter A With Grave
  ...
  {0x00e8, 0x34},	// Latin Small Letter E With Grave
  {0x00f9, 0x64},	// Latin Small Letter U With Grave
...
const DeadkeyLookup kbdfc_deadkeys[] PROGMEM = 
{
  ...
  {0x00c4, 0x0041, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ä Capital A Diaeresis
  {0x00eb, 0x0065, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ë Small E Diaeresis
  {0x00cb, 0x0045, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ë Capital E Diaeresis
  {0x00ef, 0x0069, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ï Small I Diaeresis
  {0x00cf, 0x0049, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ï Capital I Diaeresis
  {0x00f6, 0x006f, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ö Small O Diaeresis
  {0x00d6, 0x004f, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ö Capital O Diaeresis
  {0x00fc, 0x0075, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ü Small U Diaeresis
  {0x00dc, 0x0055, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ü Capital U Diaeresis
  {0x00ff, 0x0079, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ÿ Small Y Diaeresis
  {0x0060, 0x0060, 0x31 | MOD_ALTGR},	// `  accent
  {0x00e0, 0x0061, 0x31 | MOD_ALTGR},	// à Small A Grave
  {0x00c0, 0x0041, 0x31 | MOD_ALTGR},	// À Capital A Grave
  {0x00e8, 0x0065, 0x31 | MOD_ALTGR},	// è Small E Grave
  {0x00c8, 0x0045, 0x31 | MOD_ALTGR},	// È Capital E Grave
  {0x00ec, 0x0069, 0x31 | MOD_ALTGR},	// ì Small I Grave
  {0x00cc, 0x0049, 0x31 | MOD_ALTGR},	// Ì Capital I Grave
  {0x00f2, 0x006f, 0x31 | MOD_ALTGR},	// ò Small O Grave
  {0x00d2, 0x004f, 0x31 | MOD_ALTGR},	// Ò Capital O Grave
  {0x00f9, 0x0075, 0x31 | MOD_ALTGR},	// ù Small U Grave
  {0x00d9, 0x0055, 0x31 | MOD_ALTGR},	// Ù Capital U Grave
  ...
  {0x00fd, 0x0079, 0x33 | MOD_ALTGR},	// ý Small Y Acute
  {0x00dd, 0x0059, 0x33 | MOD_ALTGR},	// Ý Capital Y Acute
  ...
  {0x00e2, 0x0061, 0x2f},	// â Small A Circumflex
  {0x00c2, 0x0041, 0x2f},	// Â Capital A Circumflex
  {0x00ea, 0x0065, 0x2f},	// ê Small E Circumflex
  {0x00ca, 0x0045, 0x2f},	// Ê Capital E Circumflex
  {0x00ee, 0x0069, 0x2f},	// î Small I Circumflex
  {0x00ce, 0x0049, 0x2f},	// Î Capital I Circumflex
  {0x00f4, 0x006f, 0x2f},	// ô Small O Circumflex
  {0x00d4, 0x004f, 0x2f},	// Ô Capital O Circumflex
  {0x00fb, 0x0075, 0x2f},	// û Small U Circumflex
  {0x00db, 0x0055, 0x2f},	// Û Capital U Circumflex
};

KeyboardUTF8 Keyboard_FC(kbdfc, sizeof kbdfc / sizeof kbdfc[0], kbdfc_deadkeys, sizeof kbdfc_deadkeys / sizeof kbdfc_deadkeys[0]);
