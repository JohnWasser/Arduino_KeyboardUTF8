...
const UnicodeLookup kbdlisus[] PROGMEM = 
{
  ...
  {0x0023, 0x17 | MOD_SHIFT},	// Number Sign
  {0xa4fb, 0xa0 | MOD_SHIFT},	// Lisu Letter Tone Mya Bo
  ...
  {0x0040, 0x04 | MOD_SHIFT},	// Commercial At
  {0x0028, 0x07 | MOD_SHIFT},	// Left Parenthesis
  {0x0029, 0x09 | MOD_SHIFT},	// Right Parenthesis
  {0xa4ff, 0x0b | MOD_SHIFT},	// Lisu Punctuation Full Stop
  {0xa4fd, 0x0d | MOD_SHIFT},	// Lisu Letter Tone Mya Jeu
  {0xa4fc, 0x0e | MOD_SHIFT},	// Lisu Letter Tone Mya Na
  {0x2010, 0x0f | MOD_SHIFT},	// Hyphen
  {0xa4fa, 0x33 | MOD_SHIFT},	// Lisu Letter Tone Mya Cya
  {0x0022, 0x34 | MOD_SHIFT},	// Quotation Mark
  {0x007c, 0x64 | MOD_SHIFT},	// Vertical Line
  {0x003c, 0x1d | MOD_SHIFT},	// Less-Than Sign
  {0x003e, 0x1b | MOD_SHIFT},	// Greater-Than Sign
  {0x0026, 0x06 | MOD_SHIFT},	// Ampersand
  {0x0025, 0x19 | MOD_SHIFT},	// Percent Sign
  {0x0024, 0x05 | MOD_SHIFT},	// Dollar Sign
  {0x002a, 0x11 | MOD_SHIFT},	// Asterisk
  {0x0021, 0x10 | MOD_SHIFT},	// Exclamation Mark
  {0x002c, 0x36 | MOD_SHIFT},	// Comma
  {0x002e, 0x37 | MOD_SHIFT},	// Full Stop
  {0x002f, 0x38 | MOD_SHIFT},	// Solidus
  {0x0060, 0x35},	// Grave Accent
  {0xa4ed, 0x1e},	// Lisu Letter Gha
  {0xa4f7, 0x07},	// Lisu Letter Oe
  {0xa4f6, 0x20},	// Lisu Letter Uh
  {0xa4db, 0x21},	// Lisu Letter Cha
  {0xa4d2, 0x22},	// Lisu Letter Pha
  {0xa4e8, 0x23},	// Lisu Letter Hha
  {0xa4d8, 0x24},	// Lisu Letter Kha
  {0xa4d5, 0x25},	// Lisu Letter Tha
  {0xa4de, 0x26},	// Lisu Letter Tsha
  {0xa4e9, 0x27},	// Lisu Letter Fa
  {0xa4f5, 0x2d},	// Lisu Letter Ue
  {0x003d, 0x2e},	// Equals Sign
  {0xa4f1, 0x14},	// Lisu Letter Eu
  ...
  {0xa4e5, 0x36},	// Lisu Letter Nga
  {0xa4e4, 0x37},	// Lisu Letter Za
...
KeyboardUTF8 Keyboard_LISUS(kbdlisus, sizeof kbdlisus / sizeof kbdlisus[0], kbdlisus_deadkeys, sizeof kbdlisus_deadkeys / sizeof kbdlisus_deadkeys[0]);
