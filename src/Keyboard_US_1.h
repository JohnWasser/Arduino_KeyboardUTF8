...
const UnicodeLookup kbdus_1[] PROGMEM = 
{
...
const DeadkeyLookup kbdus_1_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_US_1(kbdus_1, sizeof kbdus_1 / sizeof kbdus_1[0], kbdus_1_deadkeys, sizeof kbdus_1_deadkeys / sizeof kbdus_1_deadkeys[0]);
