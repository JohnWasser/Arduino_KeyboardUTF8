...
const UnicodeLookup kbdgeome[] PROGMEM = 
{
  ...
  {0x10f1, 0x0b | MOD_ALTGR},	// Georgian Letter He
  {0x10f7, 0x0d | MOD_ALTGR},	// Georgian Letter Yn
  {0x10f5, 0x1d | MOD_ALTGR},	// Georgian Letter Hoe
  ...
  {0x10ed, 0x35},	// Georgian Letter Char
  ...
  {0x10df, 0x2e},	// Georgian Letter Zhar
  ...
  {0x10e8, 0x2f},	// Georgian Letter Shin
  {0x10e6, 0x30},	// Georgian Letter Ghan
  ...
  {0x10d7, 0x33},	// Georgian Letter Tan
  {0x10e9, 0x34},	// Georgian Letter Chin
  {0x003d, 0x28},	// Equals Sign
...
KeyboardUTF8 Keyboard_GEOME(kbdgeome, sizeof kbdgeome / sizeof kbdgeome[0], kbdgeome_deadkeys, sizeof kbdgeome_deadkeys / sizeof kbdgeome_deadkeys[0]);
