...
const UnicodeLookup kbdal[] PROGMEM = 
{
  ...
  {0x005b, 0x34},	// Left Square Bracket
  ...
  {0x0040, 0x30},	// Commercial At
  {0x007b, 0x34 | MOD_SHIFT},	// Left Curly Bracket
  ...
  {0x00c7, 0x2f | MOD_SHIFT},	// Latin Capital Letter C With Cedilla
  {0x0027, 0x30 | MOD_SHIFT},	// Apostrophe
  ...
  {0x00cb, 0x33 | MOD_SHIFT},	// Latin Capital Letter E With Diaeresis
  ...
  {0x00e7, 0x2f},	// Latin Small Letter C With Cedilla
  ...
  {0x00eb, 0x33},	// Latin Small Letter E With Diaeresis
...
const DeadkeyLookup kbdal_deadkeys[] PROGMEM = 
{
...
KeyboardUTF8 Keyboard_AL(kbdal, sizeof kbdal / sizeof kbdal[0], kbdal_deadkeys, sizeof kbdal_deadkeys / sizeof kbdal_deadkeys[0]);
