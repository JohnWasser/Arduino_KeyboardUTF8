...
const UnicodeLookup kbdfa[] PROGMEM = 
{
  ...
  {0x00d7, 0x35 | MOD_SHIFT},	// Multiplication Sign
  ...
  {0x064b, 0x14 | MOD_SHIFT},	// Arabic Fathatan
  {0x064c, 0x1a | MOD_SHIFT},	// Arabic Dammatan
  {0x064d, 0x08 | MOD_SHIFT},	// Arabic Kasratan
  {0x060c, 0x17 | MOD_SHIFT},	// Arabic Comma
  {0x061b, 0x1c | MOD_SHIFT},	// Arabic Semicolon
  {0x002c, 0xa0 | MOD_SHIFT},	// Comma
  {0x005d, 0x0c | MOD_SHIFT},	// Right Square Bracket
  {0x005b, 0x12 | MOD_SHIFT},	// Left Square Bracket
  {0x005c, 0x13 | MOD_SHIFT},	// Reverse Solidus
  {0x007d, 0x2f | MOD_SHIFT},	// Right Curly Bracket
  {0x007b, 0x30 | MOD_SHIFT},	// Left Curly Bracket
  {0x007c, 0x64 | MOD_SHIFT},	// Vertical Line
  {0x064e, 0x04 | MOD_SHIFT},	// Arabic Fatha
  {0x064f, 0x16 | MOD_SHIFT},	// Arabic Damma
  {0x0650, 0x07 | MOD_SHIFT},	// Arabic Kasra
  {0x0651, 0x09 | MOD_SHIFT},	// Arabic Shadda
  {0x06c0, 0x0a | MOD_SHIFT},	// Arabic Letter Heh With Yeh Above
  {0x0622, 0x0b | MOD_SHIFT},	// Arabic Letter Alef With Madda Above
  {0x0640, 0x0d | MOD_SHIFT},	// Arabic Tatweel
  {0x00ab, 0x0e | MOD_SHIFT},	// Left-Pointing Double Angle Quotation Mark *
  {0x00bb, 0x0f | MOD_SHIFT},	// Right-Pointing Double Angle Quotation Mark *
  {0x003a, 0x33 | MOD_SHIFT},	// Colon
  {0x0022, 0x34 | MOD_SHIFT},	// Quotation Mark
  {0x0629, 0x1d | MOD_SHIFT},	// Arabic Letter Teh Marbuta
  {0x064a, 0x1b | MOD_SHIFT},	// Arabic Letter Yeh
  {0x0698, 0x06 | MOD_SHIFT},	// Arabic Letter Jeh
  {0x0624, 0x19 | MOD_SHIFT},	// Arabic Letter Waw With Hamza Above
  {0x0625, 0x05 | MOD_SHIFT},	// Arabic Letter Alef With Hamza Below
  {0x0623, 0x11 | MOD_SHIFT},	// Arabic Letter Alef With Hamza Above
  {0x0621, 0x10 | MOD_SHIFT},	// Arabic Letter Hamza
  {0x003c, 0x36 | MOD_SHIFT},	// Less-Than Sign
  {0x003e, 0x37 | MOD_SHIFT},	// Greater-Than Sign
  {0x061f, 0x38 | MOD_SHIFT},	// Arabic Question Mark
  {0x00f7, 0x35},	// Division Sign
  ...
  {0x0626, 0x10},	// Arabic Letter Yeh With Hamza Above
...
KeyboardUTF8 Keyboard_FA(kbdfa, sizeof kbdfa / sizeof kbdfa[0], kbdfa_deadkeys, sizeof kbdfa_deadkeys / sizeof kbdfa_deadkeys[0]);
