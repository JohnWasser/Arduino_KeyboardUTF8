...
const UnicodeLookup kbdest[] PROGMEM = 
{
  ...
  {0x00a7, 0x30 | MOD_ALTGR},	// Section Sign
  {0x00bd, 0x31 | MOD_ALTGR},	// Vulgar Fraction One Half
  {0x0160, 0x16 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter S With Caron
  {0x005e, 0x34 | (MOD_SHIFT | MOD_ALTGR)},	// Circumflex Accent
  ...
  {0x00d5, 0x30 | MOD_SHIFT},	// Latin Capital Letter O With Tilde
  ...
  {0x00f5, 0x30},	// Latin Small Letter O With Tilde
...
const DeadkeyLookup kbdest_deadkeys[] PROGMEM = 
{
  ...
  {0x011d, 0x0067, 0x34 | MOD_ALTGR},	// ĝ Small G Circumflex
  {0x011c, 0x0047, 0x34 | MOD_ALTGR},	// Ĝ Capital G Circumflex
...
KeyboardUTF8 Keyboard_EST(kbdest, sizeof kbdest / sizeof kbdest[0], kbdest_deadkeys, sizeof kbdest_deadkeys / sizeof kbdest_deadkeys[0]);
