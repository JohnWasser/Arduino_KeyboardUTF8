...
const UnicodeLookup kbda3[] PROGMEM = 
{
...
const DeadkeyLookup kbda3_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_A3(kbda3, sizeof kbda3 / sizeof kbda3[0], kbda3_deadkeys, sizeof kbda3_deadkeys / sizeof kbda3_deadkeys[0]);
