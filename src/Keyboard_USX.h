...
const UnicodeLookup kbdusx[] PROGMEM = 
{
...
const DeadkeyLookup kbdusx_deadkeys[] PROGMEM = 
{
...
KeyboardUTF8 Keyboard_USX(kbdusx, sizeof kbdusx / sizeof kbdusx[0], kbdusx_deadkeys, sizeof kbdusx_deadkeys / sizeof kbdusx_deadkeys[0]);
