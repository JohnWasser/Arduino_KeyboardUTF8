...
const UnicodeLookup kbdne[] PROGMEM = 
{
  ...
  {0x00a3, 0x24 | MOD_ALTGR},	// Pound Sign
  {0x007b, 0x25 | MOD_ALTGR},	// Left Curly Bracket
  {0x007d, 0x26 | MOD_ALTGR},	// Right Curly Bracket
  ...
  {0x00a6, 0x64 | MOD_ALTGR},	// Broken Bar
  ...
  {0x00b7, 0x37 | MOD_ALTGR},	// Middle Dot
  ...
  {0x007c, 0x30 | MOD_SHIFT},	// Vertical Line
  ...
  {0x00b1, 0x33 | MOD_SHIFT},	// Plus-Minus Sign
  {0x003e, 0x28 | MOD_SHIFT},	// Greater-Than Sign
  {0x005b, 0x64 | MOD_SHIFT},	// Left Square Bracket
  ...
  {0x003d, 0x38 | MOD_SHIFT},	// Equals Sign
  {0x0040, 0x35},	// Commercial At
  ...
  {0x002b, 0x33},	// Plus Sign
  {0x003c, 0x28},	// Less-Than Sign
  {0x005d, 0x64},	// Right Square Bracket
...
const DeadkeyLookup kbdne_deadkeys[] PROGMEM = 
{
  ...
  {0x007e, 0x007e, 0x2e | MOD_SHIFT},	// ~  accent
  {0x00e3, 0x0061, 0x2e | MOD_SHIFT},	// ã Small A Tilde
  {0x00c3, 0x0041, 0x2e | MOD_SHIFT},	// Ã Capital A Tilde
  {0x00f1, 0x006e, 0x2e | MOD_SHIFT},	// ñ Small N Tilde
  {0x00d1, 0x004e, 0x2e | MOD_SHIFT},	// Ñ Capital N Tilde
  {0x00f5, 0x006f, 0x2e | MOD_SHIFT},	// õ Small O Tilde
  {0x00d5, 0x004f, 0x2e | MOD_SHIFT},	// Õ Capital O Tilde
  {0x005e, 0x005e, 0x2f | MOD_SHIFT},	// ^  accent
  {0x00e2, 0x0061, 0x2f | MOD_SHIFT},	// â Small A Circumflex
  {0x00c2, 0x0041, 0x2f | MOD_SHIFT},	// Â Capital A Circumflex
  {0x00ea, 0x0065, 0x2f | MOD_SHIFT},	// ê Small E Circumflex
  {0x00ca, 0x0045, 0x2f | MOD_SHIFT},	// Ê Capital E Circumflex
  {0x00ee, 0x0069, 0x2f | MOD_SHIFT},	// î Small I Circumflex
  {0x00ce, 0x0049, 0x2f | MOD_SHIFT},	// Î Capital I Circumflex
  {0x00f4, 0x006f, 0x2f | MOD_SHIFT},	// ô Small O Circumflex
  {0x00d4, 0x004f, 0x2f | MOD_SHIFT},	// Ô Capital O Circumflex
  {0x00fb, 0x0075, 0x2f | MOD_SHIFT},	// û Small U Circumflex
  {0x00db, 0x0055, 0x2f | MOD_SHIFT},	// Û Capital U Circumflex
  {0x0060, 0x0060, 0x34 | MOD_SHIFT},	// `  accent
  {0x00e0, 0x0061, 0x34 | MOD_SHIFT},	// à Small A Grave
  {0x00c0, 0x0041, 0x34 | MOD_SHIFT},	// À Capital A Grave
  {0x00e8, 0x0065, 0x34 | MOD_SHIFT},	// è Small E Grave
  {0x00c8, 0x0045, 0x34 | MOD_SHIFT},	// È Capital E Grave
  {0x00ec, 0x0069, 0x34 | MOD_SHIFT},	// ì Small I Grave
  {0x00cc, 0x0049, 0x34 | MOD_SHIFT},	// Ì Capital I Grave
  {0x00f2, 0x006f, 0x34 | MOD_SHIFT},	// ò Small O Grave
  {0x00d2, 0x004f, 0x34 | MOD_SHIFT},	// Ò Capital O Grave
  {0x00f9, 0x0075, 0x34 | MOD_SHIFT},	// ù Small U Grave
  {0x00d9, 0x0055, 0x34 | MOD_SHIFT},	// Ù Capital U Grave
  {0x00a8, 0x00a8, 0x2f},	// ¨  accent
  {0x00e4, 0x0061, 0x2f},	// ä Small A Diaeresis
  {0x00c4, 0x0041, 0x2f},	// Ä Capital A Diaeresis
  {0x00eb, 0x0065, 0x2f},	// ë Small E Diaeresis
  {0x00cb, 0x0045, 0x2f},	// Ë Capital E Diaeresis
  {0x00ef, 0x0069, 0x2f},	// ï Small I Diaeresis
  {0x00cf, 0x0049, 0x2f},	// Ï Capital I Diaeresis
  {0x00f6, 0x006f, 0x2f},	// ö Small O Diaeresis
  {0x00d6, 0x004f, 0x2f},	// Ö Capital O Diaeresis
  {0x00fc, 0x0075, 0x2f},	// ü Small U Diaeresis
  {0x00dc, 0x0055, 0x2f},	// Ü Capital U Diaeresis
  {0x00ff, 0x0079, 0x2f},	// ÿ Small Y Diaeresis
  {0x00b4, 0x00b4, 0x34},	// ´  accent
  {0x00e1, 0x0061, 0x34},	// á Small A Acute
  {0x00c1, 0x0041, 0x34},	// Á Capital A Acute
  {0x00e9, 0x0065, 0x34},	// é Small E Acute
  {0x00c9, 0x0045, 0x34},	// É Capital E Acute
  {0x00ed, 0x0069, 0x34},	// í Small I Acute
  {0x00cd, 0x0049, 0x34},	// Í Capital I Acute
  {0x00f3, 0x006f, 0x34},	// ó Small O Acute
  {0x00d3, 0x004f, 0x34},	// Ó Capital O Acute
  {0x00fa, 0x0075, 0x34},	// ú Small U Acute
  {0x00da, 0x0055, 0x34},	// Ú Capital U Acute
  {0x00fd, 0x0079, 0x34},	// ý Small Y Acute
  {0x00dd, 0x0059, 0x34},	// Ý Capital Y Acute
};

KeyboardUTF8 Keyboard_NE(kbdne, sizeof kbdne / sizeof kbdne[0], kbdne_deadkeys, sizeof kbdne_deadkeys / sizeof kbdne_deadkeys[0]);
