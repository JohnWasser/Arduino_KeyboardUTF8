...
const UnicodeLookup kbduk[] PROGMEM = 
{
...
const DeadkeyLookup kbduk_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_UK(kbduk, sizeof kbduk / sizeof kbduk[0], kbduk_deadkeys, sizeof kbduk_deadkeys / sizeof kbduk_deadkeys[0]);
