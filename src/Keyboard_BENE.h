...
const UnicodeLookup kbdbene[] PROGMEM = 
{
  ...
  {0x00b3, 0x35 | MOD_SHIFT},	// Superscript Three
  ...
  {0x002b, 0x38 | MOD_SHIFT},	// Plus Sign
...
const DeadkeyLookup kbdbene_deadkeys[] PROGMEM = 
{
  ...
  {0x007e, 0x007e, 0x38 | MOD_ALTGR},	// ~  accent
  {0x00e3, 0x0061, 0x38 | MOD_ALTGR},	// ã Small A Tilde
  {0x00c3, 0x0041, 0x38 | MOD_ALTGR},	// Ã Capital A Tilde
  {0x00f1, 0x006e, 0x38 | MOD_ALTGR},	// ñ Small N Tilde
  {0x00d1, 0x004e, 0x38 | MOD_ALTGR},	// Ñ Capital N Tilde
  {0x00f5, 0x006f, 0x38 | MOD_ALTGR},	// õ Small O Tilde
  {0x00d5, 0x004f, 0x38 | MOD_ALTGR},	// Õ Capital O Tilde
...
KeyboardUTF8 Keyboard_BENE(kbdbene, sizeof kbdbene / sizeof kbdbene[0], kbdbene_deadkeys, sizeof kbdbene_deadkeys / sizeof kbdbene_deadkeys[0]);
