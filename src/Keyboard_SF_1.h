...
const UnicodeLookup kbdsf_1[] PROGMEM = 
{
...
const DeadkeyLookup kbdsf_1_deadkeys[] PROGMEM = 
{
...
KeyboardUTF8 Keyboard_SF_1(kbdsf_1, sizeof kbdsf_1 / sizeof kbdsf_1[0], kbdsf_1_deadkeys, sizeof kbdsf_1_deadkeys / sizeof kbdsf_1_deadkeys[0]);
