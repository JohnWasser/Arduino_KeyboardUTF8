...
const UnicodeLookup kbdusa[] PROGMEM = 
{
  ...
  {0x003e, 0x35 | MOD_SHIFT},	// Greater-Than Sign
...
KeyboardUTF8 Keyboard_USA(kbdusa, sizeof kbdusa / sizeof kbdusa[0], kbdusa_deadkeys, sizeof kbdusa_deadkeys / sizeof kbdusa_deadkeys[0]);
