...
const UnicodeLookup kbdsmsfi[] PROGMEM = 
{
  ...
  {0x002a, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// Asterisk
  {0x00c2, 0x04 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter A With Circumflex
  {0x01e6, 0x0a | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter G With Caron
  {0x01e4, 0x0b | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter G With Stroke
  {0x01e8, 0x0e | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter K With Caron
  {0x00d8, 0x33 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter O With Stroke
  {0x00c6, 0x34 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter Ae (Ash) *
  {0x01ee, 0x64 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter Ezh With Caron
  {0x01b7, 0x1d | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter Ezh
  {0x0058, 0x1b | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter X
  {0x007c, 0x35 | MOD_ALTGR},	// Vertical Line
  ...
  {0x0027, 0x31 | MOD_ALTGR},	// Apostrophe
  {0x00e2, 0x04 | MOD_ALTGR},	// Latin Small Letter A With Circumflex
  {0x01e7, 0x0a | MOD_ALTGR},	// Latin Small Letter G With Caron
  {0x01e5, 0x0b | MOD_ALTGR},	// Latin Small Letter G With Stroke
  {0x01e9, 0x0e | MOD_ALTGR},	// Latin Small Letter K With Caron
  {0x00f8, 0x33 | MOD_ALTGR},	// Latin Small Letter O With Stroke
  {0x00e6, 0x34 | MOD_ALTGR},	// Latin Small Letter Ae (Ash) *
  {0x01ef, 0x64 | MOD_ALTGR},	// Latin Small Letter Ezh With Caron
  {0x0292, 0x1d | MOD_ALTGR},	// Latin Small Letter Ezh
  ...
  {0x00bd, 0x35 | MOD_SHIFT},	// Vulgar Fraction One Half
  ...
  {0x00c1, 0x14 | MOD_SHIFT},	// Latin Capital Letter A With Acute
  {0x0160, 0x1a | MOD_SHIFT},	// Latin Capital Letter S With Caron
  ...
  {0x0166, 0x1c | MOD_SHIFT},	// Latin Capital Letter T With Stroke
  ...
  {0x014a, 0x30 | MOD_SHIFT},	// Latin Capital Letter Eng (Sami)
  {0x0110, 0x31 | MOD_SHIFT},	// Latin Capital Letter D With Stroke
  ...
  {0x017d, 0x64 | MOD_SHIFT},	// Latin Capital Letter Z With Caron
  {0x005a, 0x1d | MOD_SHIFT},	// Latin Capital Letter Z
  {0x010c, 0x1b | MOD_SHIFT},	// Latin Capital Letter C With Caron
  ...
  {0x00e1, 0x14},	// Latin Small Letter A With Acute
  {0x0161, 0x1a},	// Latin Small Letter S With Caron
  {0x0065, 0x08},	// Latin Small Letter E
  {0x0072, 0x15},	// Latin Small Letter R
  {0x0074, 0x17},	// Latin Small Letter T
  {0x0167, 0x1c},	// Latin Small Letter T With Stroke
  ...
  {0x014b, 0x30},	// Latin Small Letter Eng (Sami)
  {0x0111, 0x31},	// Latin Small Letter D With Stroke
  ...
  {0x017e, 0x64},	// Latin Small Letter Z With Caron
  {0x007a, 0x1d},	// Latin Small Letter Z
  {0x010d, 0x1b},	// Latin Small Letter C With Caron
...
const DeadkeyLookup kbdsmsfi_deadkeys[] PROGMEM = 
{
  ...
  {0x00c2, 0x0041, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Â Capital A Circumflex
  {0x0109, 0x0063, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// ĉ Small C Circumflex
  {0x0108, 0x0043, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Ĉ Capital C Circumflex
  {0x00ea, 0x0065, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// ê Small E Circumflex
  {0x00ca, 0x0045, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Ê Capital E Circumflex
  {0x011d, 0x0067, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// ĝ Small G Circumflex
  {0x011c, 0x0047, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Ĝ Capital G Circumflex
  {0x0125, 0x0068, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// ĥ Small H Circumflex
  {0x0124, 0x0048, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Ĥ Capital H Circumflex
  {0x00ee, 0x0069, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// î Small I Circumflex
  {0x00ce, 0x0049, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Î Capital I Circumflex
  {0x0135, 0x006a, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// ĵ Small J Circumflex
  {0x0134, 0x004a, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Ĵ Capital J Circumflex
  {0x00f4, 0x006f, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// ô Small O Circumflex
  {0x00d4, 0x004f, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Ô Capital O Circumflex
  {0x015d, 0x0073, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// ŝ Small S Circumflex
  {0x015c, 0x0053, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Ŝ Capital S Circumflex
  {0x00fb, 0x0075, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// û Small U Circumflex
  {0x00db, 0x0055, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Û Capital U Circumflex
  {0x0175, 0x0077, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// ŵ Small W Circumflex
  {0x0174, 0x0057, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Ŵ Capital W Circumflex
  {0x0177, 0x0079, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// ŷ Small Y Circumflex
  {0x0176, 0x0059, 0x2f | (MOD_SHIFT | MOD_ALTGR)},	// Ŷ Capital Y Circumflex
  {0x02c7, 0x02c7, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ˇ  accent
  {0x010d, 0x0063, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// č Small C Caron
  {0x010c, 0x0043, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Č Capital C Caron
  {0x010f, 0x0064, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ď Small D Caron
  {0x010e, 0x0044, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ď Capital D Caron
  {0x011b, 0x0065, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ě Small E Caron
  {0x011a, 0x0045, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ě Capital E Caron
  {0x01e7, 0x0067, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ǧ Small G Caron
  {0x01e6, 0x0047, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ǧ Capital G Caron
  {0x021f, 0x0068, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ȟ Small H Caron
  {0x021e, 0x0048, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ȟ Capital H Caron
  {0x01e9, 0x006b, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ǩ Small K Caron
  {0x01e8, 0x004b, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ǩ Capital K Caron
  {0x013e, 0x006c, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ľ Small L Caron
  {0x013d, 0x004c, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ľ Capital L Caron
  {0x0148, 0x006e, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ň Small N Caron
  {0x0147, 0x004e, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ň Capital N Caron
  {0x0159, 0x0072, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ř Small R Caron
  {0x0158, 0x0052, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ř Capital R Caron
  {0x0161, 0x0073, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// š Small S Caron
  {0x0160, 0x0053, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Š Capital S Caron
  {0x0165, 0x0074, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ť Small T Caron
  {0x0164, 0x0054, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ť Capital T Caron
  {0x017e, 0x007a, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ž Small Z Caron
  {0x017d, 0x005a, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ž Capital Z Caron
  {0x01ef, 0x01ef, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// ǯ  accent
  {0x01ee, 0x01ee, 0x30 | (MOD_SHIFT | MOD_ALTGR)},	// Ǯ  accent
  ...
  {0x1e85, 0x0077, 0x2f | MOD_ALTGR},	// ẅ Small W Diaeresis
  {0x1e84, 0x0057, 0x2f | MOD_ALTGR},	// Ẅ Capital W Diaeresis
  {0x00ff, 0x0079, 0x2f | MOD_ALTGR},	// ÿ Small Y Diaeresis
  {0x0178, 0x0059, 0x2f | MOD_ALTGR},	// Ÿ Capital Y Diaeresis
  ...
  {0x01fb, 0x01fb, 0x2e},	// ǻ  accent
  {0x01fa, 0x01fa, 0x2e},	// Ǻ  accent
  {0x01fd, 0x01fd, 0x2e},	// ǽ  accent
  {0x01fc, 0x01fc, 0x2e},	// Ǽ  accent
  ...
  {0x01ff, 0x01ff, 0x2e},	// ǿ  accent
  {0x01fe, 0x01fe, 0x2e},	// Ǿ  accent
  ...
  {0x1e83, 0x0077, 0x2e},	// ẃ Small W Acute
  {0x1e82, 0x0057, 0x2e},	// Ẃ Capital W Acute
...
KeyboardUTF8 Keyboard_SMSFI(kbdsmsfi, sizeof kbdsmsfi / sizeof kbdsmsfi[0], kbdsmsfi_deadkeys, sizeof kbdsmsfi_deadkeys / sizeof kbdsmsfi_deadkeys[0]);
