...
const UnicodeLookup kbdinmar[] PROGMEM = 
{
  ...
  {0x093d, 0x1d | (MOD_SHIFT | MOD_ALTGR)},	// Devanagari Sign Avagraha
  ...
  {0x0967, 0x1e},	// Devanagari Digit One
  {0x0968, 0x1f},	// Devanagari Digit Two
  {0x0969, 0x20},	// Devanagari Digit Three
  {0x096a, 0x21},	// Devanagari Digit Four
  {0x096b, 0x22},	// Devanagari Digit Five
  {0x096c, 0x23},	// Devanagari Digit Six
  {0x096d, 0x24},	// Devanagari Digit Seven
  {0x096e, 0x25},	// Devanagari Digit Eight
  {0x096f, 0x26},	// Devanagari Digit Nine
  {0x0966, 0x27},	// Devanagari Digit Zero
...
KeyboardUTF8 Keyboard_INMAR(kbdinmar, sizeof kbdinmar / sizeof kbdinmar[0], kbdinmar_deadkeys, sizeof kbdinmar_deadkeys / sizeof kbdinmar_deadkeys[0]);
