...
const UnicodeLookup kbdpo[] PROGMEM = 
{
  ...
  {0x00a7, 0x21 | MOD_ALTGR},	// Section Sign
  ...
  {0x00bb, 0x2e | MOD_SHIFT},	// Right-Pointing Double Angle Quotation Mark *
  ...
  {0x002a, 0x2f | MOD_SHIFT},	// Asterisk
  ...
  {0x00aa, 0x34 | MOD_SHIFT},	// Feminine Ordinal Indicator
  ...
  {0x00ab, 0x2e},	// Left-Pointing Double Angle Quotation Mark *
  ...
  {0x00ba, 0x34},	// Masculine Ordinal Indicator
...
const DeadkeyLookup kbdpo_deadkeys[] PROGMEM = 
{
  ...
  {0x0060, 0x0060, 0x30 | MOD_SHIFT},	// `  accent
  {0x00e0, 0x0061, 0x30 | MOD_SHIFT},	// à Small A Grave
  {0x00c0, 0x0041, 0x30 | MOD_SHIFT},	// À Capital A Grave
  {0x00e8, 0x0065, 0x30 | MOD_SHIFT},	// è Small E Grave
  {0x00c8, 0x0045, 0x30 | MOD_SHIFT},	// È Capital E Grave
  {0x00ec, 0x0069, 0x30 | MOD_SHIFT},	// ì Small I Grave
  {0x00cc, 0x0049, 0x30 | MOD_SHIFT},	// Ì Capital I Grave
  {0x00f2, 0x006f, 0x30 | MOD_SHIFT},	// ò Small O Grave
  {0x00d2, 0x004f, 0x30 | MOD_SHIFT},	// Ò Capital O Grave
  {0x00f9, 0x0075, 0x30 | MOD_SHIFT},	// ù Small U Grave
  {0x00d9, 0x0055, 0x30 | MOD_SHIFT},	// Ù Capital U Grave
  {0x005e, 0x005e, 0x28 | MOD_SHIFT},	// ^  accent
  {0x00e2, 0x0061, 0x28 | MOD_SHIFT},	// â Small A Circumflex
  {0x00c2, 0x0041, 0x28 | MOD_SHIFT},	// Â Capital A Circumflex
  {0x00ea, 0x0065, 0x28 | MOD_SHIFT},	// ê Small E Circumflex
  {0x00ca, 0x0045, 0x28 | MOD_SHIFT},	// Ê Capital E Circumflex
  {0x00ee, 0x0069, 0x28 | MOD_SHIFT},	// î Small I Circumflex
  {0x00ce, 0x0049, 0x28 | MOD_SHIFT},	// Î Capital I Circumflex
  {0x00f4, 0x006f, 0x28 | MOD_SHIFT},	// ô Small O Circumflex
  {0x00d4, 0x004f, 0x28 | MOD_SHIFT},	// Ô Capital O Circumflex
  {0x00fb, 0x0075, 0x28 | MOD_SHIFT},	// û Small U Circumflex
  {0x00db, 0x0055, 0x28 | MOD_SHIFT},	// Û Capital U Circumflex
  {0x00b4, 0x00b4, 0x30},	// ´  accent
  {0x00e1, 0x0061, 0x30},	// á Small A Acute
  {0x00c1, 0x0041, 0x30},	// Á Capital A Acute
  {0x00e9, 0x0065, 0x30},	// é Small E Acute
  {0x00c9, 0x0045, 0x30},	// É Capital E Acute
  {0x00ed, 0x0069, 0x30},	// í Small I Acute
  {0x00cd, 0x0049, 0x30},	// Í Capital I Acute
  {0x00f3, 0x006f, 0x30},	// ó Small O Acute
  {0x00d3, 0x004f, 0x30},	// Ó Capital O Acute
  {0x00fa, 0x0075, 0x30},	// ú Small U Acute
  {0x00da, 0x0055, 0x30},	// Ú Capital U Acute
  {0x00fd, 0x0079, 0x30},	// ý Small Y Acute
  {0x00dd, 0x0059, 0x30},	// Ý Capital Y Acute
  {0x007e, 0x007e, 0x28},	// ~  accent
  {0x00e3, 0x0061, 0x28},	// ã Small A Tilde
  {0x00c3, 0x0041, 0x28},	// Ã Capital A Tilde
  {0x00f1, 0x006e, 0x28},	// ñ Small N Tilde
  {0x00d1, 0x004e, 0x28},	// Ñ Capital N Tilde
  {0x00f5, 0x006f, 0x28},	// õ Small O Tilde
  {0x00d5, 0x004f, 0x28},	// Õ Capital O Tilde
};

KeyboardUTF8 Keyboard_PO(kbdpo, sizeof kbdpo / sizeof kbdpo[0], kbdpo_deadkeys, sizeof kbdpo_deadkeys / sizeof kbdpo_deadkeys[0]);
