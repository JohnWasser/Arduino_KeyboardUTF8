...
const UnicodeLookup kbdkyr[] PROGMEM = 
{
  ...
  {0x04ae, 0x08 | (MOD_SHIFT | MOD_ALTGR)},	// Cyrillic Capital Letter Straight U
  {0x04a2, 0x1c | (MOD_SHIFT | MOD_ALTGR)},	// Cyrillic Capital Letter En With Descender
  {0x04e8, 0x0d | (MOD_SHIFT | MOD_ALTGR)},	// Cyrillic Capital Letter Barred O
  {0x04af, 0x08 | MOD_ALTGR},	// Cyrillic Small Letter Straight U
  {0x04a3, 0x1c | MOD_ALTGR},	// Cyrillic Small Letter En With Descender
  {0x04e9, 0x0d | MOD_ALTGR},	// Cyrillic Small Letter Barred O
...
const DeadkeyLookup kbdkyr_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_KYR(kbdkyr, sizeof kbdkyr / sizeof kbdkyr[0], kbdkyr_deadkeys, sizeof kbdkyr_deadkeys / sizeof kbdkyr_deadkeys[0]);
