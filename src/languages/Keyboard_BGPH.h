...
const UnicodeLookup kbdbgph[] PROGMEM = 
{
  ...
  {0x042e, 0x35 | MOD_SHIFT},	// Cyrillic Capital Letter Yu
  ...
  {0x2013, 0x2d | MOD_SHIFT},	// En Dash
  {0x002b, 0x2e | MOD_SHIFT},	// Plus Sign
  {0x0427, 0x14 | MOD_SHIFT},	// Cyrillic Capital Letter Che
  ...
  {0x042f, 0x2f | MOD_SHIFT},	// Cyrillic Capital Letter Ya
  {0x0429, 0x30 | MOD_SHIFT},	// Cyrillic Capital Letter Shcha
  {0x045d, 0x64},	// Cyrillic Small Letter I With Grave
  ...
  {0x040d, 0x64 | MOD_SHIFT},	// Cyrillic Capital Letter I With Grave
  ...
  {0x201e, 0x36 | MOD_SHIFT},	// Double Low-9 Quotation Mark
  {0x201c, 0x37 | MOD_SHIFT},	// Left Double Quotation Mark
  {0x003f, 0x38 | MOD_SHIFT},	// Question Mark
  {0x044e, 0x35},	// Cyrillic Small Letter Yu
  ...
  {0x0447, 0x14},	// Cyrillic Small Letter Che
  ...
  {0x044f, 0x2f},	// Cyrillic Small Letter Ya
  {0x0449, 0x30},	// Cyrillic Small Letter Shcha
  {0x044c, 0x31},	// Cyrillic Small Letter Soft Sign
...
const DeadkeyLookup kbdbgph_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_BGPH(kbdbgph, sizeof kbdbgph / sizeof kbdbgph[0], kbdbgph_deadkeys, sizeof kbdbgph_deadkeys / sizeof kbdbgph_deadkeys[0]);
