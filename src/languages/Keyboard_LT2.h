...
const UnicodeLookup kbdlt2[] PROGMEM = 
{
  ...
  {0x00b4, 0x35 | MOD_ALTGR},	// Acute Accent
  {0x0040, 0x1e | MOD_ALTGR},	// Commercial At
  {0x005f, 0x1f | MOD_ALTGR},	// Low Line
  ...
  {0x0027, 0x2d | MOD_ALTGR},	// Apostrophe
  {0x0025, 0x2e | MOD_ALTGR},	// Percent Sign
  ...
  {0x0022, 0x34 | MOD_ALTGR},	// Quotation Mark
  {0x2013, 0x64 | MOD_ALTGR},	// En Dash
  {0x201e, 0x36 | MOD_ALTGR},	// Double Low-9 Quotation Mark
  {0x201c, 0x37 | MOD_ALTGR},	// Left Double Quotation Mark
  ...
  {0x0058, 0x2e | MOD_SHIFT},	// Latin Capital Letter X
  ...
  {0x0051, 0x31 | MOD_SHIFT},	// Latin Capital Letter Q
  ...
  {0x0160, 0x09 | MOD_SHIFT},	// Latin Capital Letter S With Caron
  ...
  {0x0046, 0x37 | MOD_SHIFT},	// Latin Capital Letter F
  ...
  {0x003d, 0x25},	// Equals Sign
  {0x0028, 0x26},	// Left Parenthesis
  {0x0029, 0x27},	// Right Parenthesis
  {0x003f, 0x2d},	// Question Mark
  {0x0078, 0x2e},	// Latin Small Letter X
  ...
  {0x0066, 0x37},	// Latin Small Letter F
...
KeyboardUTF8 Keyboard_LT2(kbdlt2, sizeof kbdlt2 / sizeof kbdlt2[0], kbdlt2_deadkeys, sizeof kbdlt2_deadkeys / sizeof kbdlt2_deadkeys[0]);
