...
const UnicodeLookup kbdosm[] PROGMEM = 
{
  ...
  {0x104a, 0x27},	//  Osmanya Digit Zero
...
KeyboardUTF8 Keyboard_OSM(kbdosm, sizeof kbdosm / sizeof kbdosm[0], kbdosm_deadkeys, sizeof kbdosm_deadkeys / sizeof kbdosm_deadkeys[0]);
