...
const UnicodeLookup kbdbulg[] PROGMEM = 
{
  ...
  {0x2013, 0x26 | MOD_SHIFT},	// En Dash
  {0x2116, 0x27 | MOD_SHIFT},	// Numero Sign
  {0x0024, 0x2d | MOD_SHIFT},	// Dollar Sign
  {0x20ac, 0x2e | MOD_SHIFT},	// Euro Sign
  ...
  {0x201c, 0x28 | MOD_SHIFT},	// Left Double Quotation Mark
  ...
  {0x201e, 0x28},	// Double Low-9 Quotation Mark
...
KeyboardUTF8 Keyboard_BULG(kbdbulg, sizeof kbdbulg / sizeof kbdbulg[0], kbdbulg_deadkeys, sizeof kbdbulg_deadkeys / sizeof kbdbulg_deadkeys[0]);
