...
const UnicodeLookup kbdcr_2[] PROGMEM = 
{
  ...
  {0x00a4, 0x28 | MOD_ALTGR},	// Currency Sign
  ...
  {0x0160, 0x2f | MOD_SHIFT},	// Latin Capital Letter S With Caron
  {0x0110, 0x30 | MOD_SHIFT},	// Latin Capital Letter D With Stroke
  ...
  {0x010c, 0x33 | MOD_SHIFT},	// Latin Capital Letter C With Caron
  {0x0106, 0x34 | MOD_SHIFT},	// Latin Capital Letter C With Acute
  {0x017d, 0x28 | MOD_SHIFT},	// Latin Capital Letter Z With Caron
  ...
  {0x0161, 0x2f},	// Latin Small Letter S With Caron
  {0x0111, 0x30},	// Latin Small Letter D With Stroke
  ...
  {0x010d, 0x33},	// Latin Small Letter C With Caron
  {0x0107, 0x34},	// Latin Small Letter C With Acute
  {0x017e, 0x28},	// Latin Small Letter Z With Caron
...
const DeadkeyLookup kbdcr_2_deadkeys[] PROGMEM = 
{
  ...
  {0x02d9, 0x02d9, 0x25 | MOD_ALTGR},	// ˙  accent
  ...
  {0x00b8, 0x00b8, 0x35},	// ¸  accent
  {0x00e7, 0x0063, 0x35},	// ç Small C Cedilla
  {0x00c7, 0x0043, 0x35},	// Ç Capital C Cedilla
  {0x015f, 0x0073, 0x35},	// ş Small S Cedilla
  {0x015e, 0x0053, 0x35},	// Ş Capital S Cedilla
};

KeyboardUTF8 Keyboard_CR_2(kbdcr_2, sizeof kbdcr_2 / sizeof kbdcr_2[0], kbdcr_2_deadkeys, sizeof kbdcr_2_deadkeys / sizeof kbdcr_2_deadkeys[0]);
