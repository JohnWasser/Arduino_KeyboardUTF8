...
const DeadkeyLookup kbdyba_deadkeys[] PROGMEM = 
{
  ...
  {0x01f9, 0x006e, 0x2f},	// ǹ Small N Grave
  {0x01f8, 0x004e, 0x2f},	// Ǹ Capital N Grave
  ...
  {0x1eb9, 0x0065, 0x31},	// ẹ Small E Dot Below
  {0x1eb8, 0x0045, 0x31},	// Ẹ Capital E Dot Below
  {0x1ecd, 0x006f, 0x31},	// ọ Small O Dot Below
  {0x1ecc, 0x004f, 0x31},	// Ọ Capital O Dot Below
  {0x1e63, 0x0073, 0x31},	// ṣ Small S Dot Below
  {0x1e62, 0x0053, 0x31},	// Ṣ Capital S Dot Below
...
KeyboardUTF8 Keyboard_YBA(kbdyba, sizeof kbdyba / sizeof kbdyba[0], kbdyba_deadkeys, sizeof kbdyba_deadkeys / sizeof kbdyba_deadkeys[0]);
