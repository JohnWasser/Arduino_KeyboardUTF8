...
const UnicodeLookup kbdno[] PROGMEM = 
{
...
const DeadkeyLookup kbdno_deadkeys[] PROGMEM = 
{
...
KeyboardUTF8 Keyboard_NO(kbdno, sizeof kbdno / sizeof kbdno[0], kbdno_deadkeys, sizeof kbdno_deadkeys / sizeof kbdno_deadkeys[0]);
