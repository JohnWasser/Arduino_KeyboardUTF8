...
const UnicodeLookup kbdycc[] PROGMEM = 
{
...
const DeadkeyLookup kbdycc_deadkeys[] PROGMEM = 
{
...
KeyboardUTF8 Keyboard_YCC(kbdycc, sizeof kbdycc / sizeof kbdycc[0], kbdycc_deadkeys, sizeof kbdycc_deadkeys / sizeof kbdycc_deadkeys[0]);
