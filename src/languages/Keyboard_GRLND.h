...
const UnicodeLookup kbdgrlnd[] PROGMEM = 
{
  ...
  {0x007c, 0x2e | MOD_ALTGR},	// Vertical Line
  ...
  {0x0138, 0x0e | MOD_ALTGR},	// Latin Small Letter Kra (Greenlandic)
  ...
  {0x00d8, 0x34 | MOD_SHIFT},	// Latin Capital Letter O With Stroke
  ...
  {0x00f8, 0x34},	// Latin Small Letter O With Stroke
...
KeyboardUTF8 Keyboard_GRLND(kbdgrlnd, sizeof kbdgrlnd / sizeof kbdgrlnd[0], kbdgrlnd_deadkeys, sizeof kbdgrlnd_deadkeys / sizeof kbdgrlnd_deadkeys[0]);
