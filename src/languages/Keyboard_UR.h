...
const UnicodeLookup kbdur[] PROGMEM = 
{
...
const DeadkeyLookup kbdur_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_UR(kbdur, sizeof kbdur / sizeof kbdur[0], kbdur_deadkeys, sizeof kbdur_deadkeys / sizeof kbdur_deadkeys[0]);
