...
const UnicodeLookup kbdropr[] PROGMEM = 
{
  ...
  {0x2013, 0x2d | (MOD_SHIFT | MOD_ALTGR)},	// En Dash
  {0x00b1, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// Plus-Minus Sign
  {0x00c2, 0x14 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter A With Circumflex
  {0x021a, 0x17 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter T With Comma Below *
  {0x00ce, 0x0c | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter I With Circumflex
  {0x0102, 0x04 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter A With Breve
  {0x0218, 0x16 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter S With Comma Below *
  ...
  {0x00df, 0x1a | MOD_ALTGR},	// Latin Small Letter Sharp S (German)
  {0x20ac, 0x08 | MOD_ALTGR},	// Euro Sign
  {0x021b, 0x17 | MOD_ALTGR},	// Latin Small Letter T With Comma Below *
  {0x00ee, 0x0c | MOD_ALTGR},	// Latin Small Letter I With Circumflex
  {0x00a7, 0x13 | MOD_ALTGR},	// Section Sign
  {0x201e, 0x2f | MOD_ALTGR},	// Double Low-9 Quotation Mark
  {0x201d, 0x30 | MOD_ALTGR},	// Right Double Quotation Mark
  {0x0103, 0x04 | MOD_ALTGR},	// Latin Small Letter A With Breve
  {0x0219, 0x16 | MOD_ALTGR},	// Latin Small Letter S With Comma Below *
...
const DeadkeyLookup kbdropr_deadkeys[] PROGMEM = 
{
  ...
  {0x00ea, 0x0065, 0x20 | MOD_ALTGR},	// ê Small E Circumflex
  {0x00ca, 0x0045, 0x20 | MOD_ALTGR},	// Ê Capital E Circumflex
  ...
  {0x00fb, 0x0075, 0x20 | MOD_ALTGR},	// û Small U Circumflex
  {0x00db, 0x0055, 0x20 | MOD_ALTGR},	// Û Capital U Circumflex
  ...
  {0x00ef, 0x0069, 0x2d | MOD_ALTGR},	// ï Small I Diaeresis
  {0x00cf, 0x0049, 0x2d | MOD_ALTGR},	// Ï Capital I Diaeresis
  ...
  {0x00ff, 0x0079, 0x2d | MOD_ALTGR},	// ÿ Small Y Diaeresis
  {0x0178, 0x0059, 0x2d | MOD_ALTGR},	// Ÿ Capital Y Diaeresis
  ...
  {0x015f, 0x0073, 0x2e | MOD_ALTGR},	// ş Small S Cedilla
  {0x015e, 0x0053, 0x2e | MOD_ALTGR},	// Ş Capital S Cedilla
  {0x0163, 0x0074, 0x2e | MOD_ALTGR},	// ţ Small T Cedilla
  {0x0162, 0x0054, 0x2e | MOD_ALTGR},	// Ţ Capital T Cedilla
};

KeyboardUTF8 Keyboard_ROPR(kbdropr, sizeof kbdropr / sizeof kbdropr[0], kbdropr_deadkeys, sizeof kbdropr_deadkeys / sizeof kbdropr_deadkeys[0]);
