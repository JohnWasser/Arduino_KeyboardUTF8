...
const UnicodeLookup kbdsl[] PROGMEM = 
{
...
const DeadkeyLookup kbdsl_deadkeys[] PROGMEM = 
{
...
KeyboardUTF8 Keyboard_SL(kbdsl, sizeof kbdsl / sizeof kbdsl[0], kbdsl_deadkeys, sizeof kbdsl_deadkeys / sizeof kbdsl_deadkeys[0]);
