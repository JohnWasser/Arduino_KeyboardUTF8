...
const UnicodeLookup kbdfi[] PROGMEM = 
{
...
const DeadkeyLookup kbdfi_deadkeys[] PROGMEM = 
{
...
KeyboardUTF8 Keyboard_FI(kbdfi, sizeof kbdfi / sizeof kbdfi[0], kbdfi_deadkeys, sizeof kbdfi_deadkeys / sizeof kbdfi_deadkeys[0]);
