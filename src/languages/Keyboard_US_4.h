...
const UnicodeLookup kbdus_4[] PROGMEM = 
{
...
const DeadkeyLookup kbdus_4_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_US_4(kbdus_4, sizeof kbdus_4 / sizeof kbdus_4[0], kbdus_4_deadkeys, sizeof kbdus_4_deadkeys / sizeof kbdus_4_deadkeys[0]);
