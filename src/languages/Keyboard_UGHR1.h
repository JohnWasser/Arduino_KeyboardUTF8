...
const UnicodeLookup kbdughr1[] PROGMEM = 
{
  ...
  {0x0641, 0x09 | MOD_SHIFT},	// Arabic Letter Feh
...
KeyboardUTF8 Keyboard_UGHR1(kbdughr1, sizeof kbdughr1 / sizeof kbdughr1[0], kbdughr1_deadkeys, sizeof kbdughr1_deadkeys / sizeof kbdughr1_deadkeys[0]);
