...
const UnicodeLookup kbdinbe1[] PROGMEM = 
{
...
const DeadkeyLookup kbdinbe1_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_INBE1(kbdinbe1, sizeof kbdinbe1 / sizeof kbdinbe1[0], kbdinbe1_deadkeys, sizeof kbdinbe1_deadkeys / sizeof kbdinbe1_deadkeys[0]);
