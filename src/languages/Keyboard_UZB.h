...
const UnicodeLookup kbduzb[] PROGMEM = 
{
  ...
  {0x04b2, 0x2e | MOD_SHIFT},	// Cyrillic Capital Letter Ha With Descender
  ...
  {0x049a, 0x16 | MOD_SHIFT},	// Cyrillic Capital Letter Ka With Descender
  ...
  {0x04b3, 0x2e},	// Cyrillic Small Letter Ha With Descender
  ...
  {0x049b, 0x16},	// Cyrillic Small Letter Ka With Descender
...
KeyboardUTF8 Keyboard_UZB(kbduzb, sizeof kbduzb / sizeof kbduzb[0], kbduzb_deadkeys, sizeof kbduzb_deadkeys / sizeof kbduzb_deadkeys[0]);
