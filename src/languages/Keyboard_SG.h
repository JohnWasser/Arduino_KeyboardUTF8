...
const UnicodeLookup kbdsg[] PROGMEM = 
{
  ...
  {0x00e8, 0x2f | MOD_SHIFT},	// Latin Small Letter E With Grave
  ...
  {0x00e9, 0x33 | MOD_SHIFT},	// Latin Small Letter E With Acute
  {0x00e0, 0x34 | MOD_SHIFT},	// Latin Small Letter A With Grave
...
const DeadkeyLookup kbdsg_deadkeys[] PROGMEM = 
{
...
KeyboardUTF8 Keyboard_SG(kbdsg, sizeof kbdsg / sizeof kbdsg[0], kbdsg_deadkeys, sizeof kbdsg_deadkeys / sizeof kbdsg_deadkeys[0]);
