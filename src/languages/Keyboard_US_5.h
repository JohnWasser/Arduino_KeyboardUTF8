...
const UnicodeLookup kbdus_5[] PROGMEM = 
{
...
const DeadkeyLookup kbdus_5_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_US_5(kbdus_5, sizeof kbdus_5 / sizeof kbdus_5[0], kbdus_5_deadkeys, sizeof kbdus_5_deadkeys / sizeof kbdus_5_deadkeys[0]);
