...
const UnicodeLookup kbdus_2[] PROGMEM = 
{
...
const DeadkeyLookup kbdus_2_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_US_2(kbdus_2, sizeof kbdus_2 / sizeof kbdus_2[0], kbdus_2_deadkeys, sizeof kbdus_2_deadkeys / sizeof kbdus_2_deadkeys[0]);
