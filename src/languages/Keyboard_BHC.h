...
const UnicodeLookup kbdbhc[] PROGMEM = 
{
  ...
  {0x0417, 0x1c | MOD_SHIFT},	// Cyrillic Capital Letter Ze
  ...
  {0x0402, 0x30 | MOD_SHIFT},	// Cyrillic Capital Letter Dje (Serbocroatian)
  ...
  {0x040b, 0x34 | MOD_SHIFT},	// Cyrillic Capital Letter Tshe (Serbocroatian)
  {0x0416, 0x28 | MOD_SHIFT},	// Cyrillic Capital Letter Zhe
  {0x0405, 0x1d | MOD_SHIFT},	// Cyrillic Capital Letter Dze
  ...
  {0x0437, 0x1c},	// Cyrillic Small Letter Ze
  ...
  {0x0452, 0x30},	// Cyrillic Small Letter Dje (Serbocroatian)
  ...
  {0x045b, 0x34},	// Cyrillic Small Letter Tshe (Serbocroatian)
  {0x0436, 0x28},	// Cyrillic Small Letter Zhe
  {0x0455, 0x1d},	// Cyrillic Small Letter Dze
...
const DeadkeyLookup kbdbhc_deadkeys[] PROGMEM = 
{
  ...
  {0x0453, 0x0453, 0x2d},	// ѓ  accent
  {0x0403, 0x0403, 0x2d},	// Ѓ  accent
  {0x045c, 0x045c, 0x2d},	// ќ  accent
  {0x040c, 0x040c, 0x2d},	// Ќ  accent
};

KeyboardUTF8 Keyboard_BHC(kbdbhc, sizeof kbdbhc / sizeof kbdbhc[0], kbdbhc_deadkeys, sizeof kbdbhc_deadkeys / sizeof kbdbhc_deadkeys[0]);
