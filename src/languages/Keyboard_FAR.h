...
const UnicodeLookup kbdfar[] PROGMEM = 
{
  ...
  {0x060c, 0x24 | MOD_SHIFT},	// Arabic Comma
  ...
  {0x005d, 0x12 | MOD_SHIFT},	// Right Square Bracket
  {0x005b, 0x13 | MOD_SHIFT},	// Left Square Bracket
  {0x007d, 0x2f | MOD_SHIFT},	// Right Curly Bracket
  {0x007b, 0x30 | MOD_SHIFT},	// Left Curly Bracket
  {0x0624, 0x04 | MOD_SHIFT},	// Arabic Letter Waw With Hamza Above
  {0x0626, 0x16 | MOD_SHIFT},	// Arabic Letter Yeh With Hamza Above
  ...
  {0x0629, 0x0d | MOD_SHIFT},	// Arabic Letter Teh Marbuta
  {0x00bb, 0x0e | MOD_SHIFT},	// Right-Pointing Double Angle Quotation Mark *
  {0x00ab, 0x0f | MOD_SHIFT},	// Left-Pointing Double Angle Quotation Mark *
  {0x003a, 0x33 | MOD_SHIFT},	// Colon
  {0x061b, 0x34 | MOD_SHIFT},	// Arabic Semicolon
  {0x007c, 0x64 | MOD_SHIFT},	// Vertical Line
  {0x0643, 0x1d | MOD_SHIFT},	// Arabic Letter Kaf
  {0x0637, 0x1b},	// Arabic Letter Tah
  {0x0698, 0x06 | MOD_SHIFT},	// Arabic Letter Jeh
  {0x0670, 0x19 | MOD_SHIFT},	// Arabic Letter Superscript Alef
  {0x200c, 0x05 | MOD_SHIFT},	// Zero Width Non-Joiner
  {0x0654, 0x11 | MOD_SHIFT},	// Arabic Hamza Above
  ...
  {0x067e, 0x10},	// Arabic Letter Peh
  {0x0648, 0x36},	// Arabic Letter Waw
  {0x002e, 0x37},	// Full Stop
  {0x002f, 0x38},	// Solidus
};

const DeadkeyLookup kbdfar_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_FAR(kbdfar, sizeof kbdfar / sizeof kbdfar[0], kbdfar_deadkeys, sizeof kbdfar_deadkeys / sizeof kbdfar_deadkeys[0]);
