...
const UnicodeLookup kbdhau[] PROGMEM = 
{
  ...
  {0x01b3, 0x1c | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter Y With Hook
  {0x00a6, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// Broken Bar
  {0x018a, 0x07 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter D With Hook
  {0x0198, 0x0e | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter K With Hook
  {0x0181, 0x05 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter B With Hook
  ...
  {0x01b4, 0x1c | MOD_ALTGR},	// Latin Small Letter Y With Hook
  {0x0257, 0x07 | MOD_ALTGR},	// Latin Small Letter D With Hook
  {0x0199, 0x0e | MOD_ALTGR},	// Latin Small Letter K With Hook
  {0x00b6, 0x33 | MOD_ALTGR},	// Pilcrow Sign
  {0x0253, 0x05 | MOD_ALTGR},	// Latin Small Letter B With Hook
...
const DeadkeyLookup kbdhau_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_HAU(kbdhau, sizeof kbdhau / sizeof kbdhau[0], kbdhau_deadkeys, sizeof kbdhau_deadkeys / sizeof kbdhau_deadkeys[0]);
