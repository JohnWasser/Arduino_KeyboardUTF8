...
const UnicodeLookup kbdkaz[] PROGMEM = 
{
  ...
  {0x0029, 0x35 | MOD_SHIFT},	// Right Parenthesis
  {0x0021, 0x1e | MOD_SHIFT},	// Exclamation Mark
  {0x04d8, 0x1f | MOD_SHIFT},	// Cyrillic Capital Letter Schwa
  {0x0406, 0x20 | MOD_SHIFT},	// Cyrillic Capital Letter Byelorussian-Ukrainian I
  {0x04a2, 0x21 | MOD_SHIFT},	// Cyrillic Capital Letter En With Descender
  {0x0492, 0x22 | MOD_SHIFT},	// Cyrillic Capital Letter Ghe With Stroke
  {0x003b, 0x23 | MOD_SHIFT},	// Semicolon
  {0x003a, 0x24 | MOD_SHIFT},	// Colon
  {0x04ae, 0x25 | MOD_SHIFT},	// Cyrillic Capital Letter Straight U
  {0x04b0, 0x26 | MOD_SHIFT},	// Cyrillic Capital Letter Straight U With Stroke
  {0x049a, 0x27 | MOD_SHIFT},	// Cyrillic Capital Letter Ka With Descender
  {0x04e8, 0x2d | MOD_SHIFT},	// Cyrillic Capital Letter Barred O
  {0x04ba, 0x2e | MOD_SHIFT},	// Cyrillic Capital Letter Shha
  ...
  {0x0028, 0x35},	// Left Parenthesis
  {0x0022, 0x1e},	// Quotation Mark
  {0x04d9, 0x1f},	// Cyrillic Small Letter Schwa
  {0x0456, 0x20},	// Cyrillic Small Letter Byelorussian-Ukrainian I
  {0x04a3, 0x21},	// Cyrillic Small Letter En With Descender
  {0x0493, 0x22},	// Cyrillic Small Letter Ghe With Stroke
  {0x002c, 0x23},	// Comma
  {0x002e, 0x24},	// Full Stop
  {0x04af, 0x25},	// Cyrillic Small Letter Straight U
  {0x04b1, 0x26},	// Cyrillic Small Letter Straight U With Stroke
  {0x049b, 0x27},	// Cyrillic Small Letter Ka With Descender
  {0x04e9, 0x2d},	// Cyrillic Small Letter Barred O
  {0x04bb, 0x2e},	// Cyrillic Small Letter Shha
...
KeyboardUTF8 Keyboard_KAZ(kbdkaz, sizeof kbdkaz / sizeof kbdkaz[0], kbdkaz_deadkeys, sizeof kbdkaz_deadkeys / sizeof kbdkaz_deadkeys[0]);
