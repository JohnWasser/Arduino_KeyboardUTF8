...
const UnicodeLookup kbdtajik[] PROGMEM = 
{
  ...
  {0x0492, 0x2d | MOD_SHIFT},	// Cyrillic Capital Letter Ghe With Stroke
  {0x04ee, 0x2e | MOD_SHIFT},	// Cyrillic Capital Letter U With Macron
  {0x0419, 0x14 | MOD_SHIFT},	// Cyrillic Capital Letter Short I
  {0x049a, 0x1a | MOD_SHIFT},	// Cyrillic Capital Letter Ka With Descender
  ...
  {0x04b2, 0x12 | MOD_SHIFT},	// Cyrillic Capital Letter Ha With Descender
  ...
  {0x04b6, 0x16 | MOD_SHIFT},	// Cyrillic Capital Letter Che With Descender
  ...
  {0x04e2, 0x10 | MOD_SHIFT},	// Cyrillic Capital Letter I With Macron
  ...
  {0x0493, 0x2d},	// Cyrillic Small Letter Ghe With Stroke
  {0x04ef, 0x2e},	// Cyrillic Small Letter U With Macron
  {0x0439, 0x14},	// Cyrillic Small Letter Short I
  {0x049b, 0x1a},	// Cyrillic Small Letter Ka With Descender
  ...
  {0x04b3, 0x12},	// Cyrillic Small Letter Ha With Descender
  ...
  {0x04b7, 0x16},	// Cyrillic Small Letter Che With Descender
  ...
  {0x04e3, 0x10},	// Cyrillic Small Letter I With Macron
...
KeyboardUTF8 Keyboard_TAJIK(kbdtajik, sizeof kbdtajik / sizeof kbdtajik[0], kbdtajik_deadkeys, sizeof kbdtajik_deadkeys / sizeof kbdtajik_deadkeys[0]);
