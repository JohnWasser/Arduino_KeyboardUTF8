...
const UnicodeLookup kbda1[] PROGMEM = 
{
  ...
  {0x0651, 0x35 | MOD_SHIFT},	// Arabic Shadda
  ...
  {0x003c, 0x2f | MOD_SHIFT},	// Less-Than Sign
  {0x003e, 0x30 | MOD_SHIFT},	// Greater-Than Sign
  {0x007c, 0x64 | MOD_SHIFT},	// Vertical Line
  {0x0650, 0x04 | MOD_SHIFT},	// Arabic Kasra
  {0x064d, 0x16 | MOD_SHIFT},	// Arabic Kasratan
  ...
  {0x007d, 0x06 | MOD_SHIFT},	// Right Curly Bracket
  {0x007b, 0x19 | MOD_SHIFT},	// Left Curly Bracket
  ...
  {0x0630, 0x35},	// Arabic Letter Thal
...
KeyboardUTF8 Keyboard_A1(kbda1, sizeof kbda1 / sizeof kbda1[0], kbda1_deadkeys, sizeof kbda1_deadkeys / sizeof kbda1_deadkeys[0]);
