...
const UnicodeLookup kbdturme[] PROGMEM = 
{
  ...
  {0x017d, 0x35 | MOD_SHIFT},	// Latin Capital Letter Z With Caron
  ...
  {0x2116, 0x23 | MOD_SHIFT},	// Numero Sign
  ...
  {0x00c4, 0x14 | MOD_SHIFT},	// Latin Capital Letter A With Diaeresis
  ...
  {0x0147, 0x2f | MOD_SHIFT},	// Latin Capital Letter N With Caron
  {0x00d6, 0x30 | MOD_SHIFT},	// Latin Capital Letter O With Diaeresis
  {0x015e, 0x31 | MOD_SHIFT},	// Latin Capital Letter S With Cedilla *
  ...
  {0x00dc, 0x1b | MOD_SHIFT},	// Latin Capital Letter U With Diaeresis
  {0x00c7, 0x06 | MOD_SHIFT},	// Latin Capital Letter C With Cedilla
  {0x00dd, 0x19 | MOD_SHIFT},	// Latin Capital Letter Y With Acute
  ...
  {0x017e, 0x35},	// Latin Small Letter Z With Caron
  ...
  {0x00e4, 0x14},	// Latin Small Letter A With Diaeresis
  ...
  {0x0148, 0x2f},	// Latin Small Letter N With Caron
  {0x00f6, 0x30},	// Latin Small Letter O With Diaeresis
  {0x015f, 0x31},	// Latin Small Letter S With Cedilla *
  ...
  {0x00fc, 0x1b},	// Latin Small Letter U With Diaeresis
  {0x00e7, 0x06},	// Latin Small Letter C With Cedilla
  {0x00fd, 0x19},	// Latin Small Letter Y With Acute
...
KeyboardUTF8 Keyboard_TURME(kbdturme, sizeof kbdturme / sizeof kbdturme[0], kbdturme_deadkeys, sizeof kbdturme_deadkeys / sizeof kbdturme_deadkeys[0]);
