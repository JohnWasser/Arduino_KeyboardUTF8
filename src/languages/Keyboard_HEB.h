...
const UnicodeLookup kbdheb[] PROGMEM = 
{
  ...
  {0x05bf, 0x2d | MOD_ALTGR},	// Hebrew Point Rafe
  {0x20ac, 0x08 | MOD_ALTGR},	// Euro Sign
  {0x05f0, 0xa0 | MOD_ALTGR},	// Hebrew Ligature Yiddish Double Vav
  {0x05f2, 0x0b | MOD_ALTGR},	// Hebrew Ligature Yiddish Double Yod
  {0x05f1, 0x0d | MOD_ALTGR},	// Hebrew Ligature Yiddish Vav Yod
...
KeyboardUTF8 Keyboard_HEB(kbdheb, sizeof kbdheb / sizeof kbdheb[0], kbdheb_deadkeys, sizeof kbdheb_deadkeys / sizeof kbdheb_deadkeys[0]);
