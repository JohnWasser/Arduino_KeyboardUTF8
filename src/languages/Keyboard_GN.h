...
const UnicodeLookup kbdgn[] PROGMEM = 
{
  ...
  {0x1ebc, 0x08 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter E With Tilde
  {0x1ef8, 0x1c | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter Y With Tilde
  {0x0168, 0xa0 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter U With Tilde
  {0x0128, 0x0c | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter I With Tilde
  {0x00d5, 0x12 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter O With Tilde
  {0x00c3, 0x04 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter A With Tilde
  {0x00ac, 0x35 | MOD_ALTGR},	// Not Sign
  {0x005c, 0x2d | MOD_ALTGR},	// Reverse Solidus
  {0x0040, 0x14 | MOD_ALTGR},	// Commercial At
  {0x1ebd, 0x08 | MOD_ALTGR},	// Latin Small Letter E With Tilde
  {0x1ef9, 0x1c | MOD_ALTGR},	// Latin Small Letter Y With Tilde
  {0x0169, 0xa0 | MOD_ALTGR},	// Latin Small Letter U With Tilde
  {0x0129, 0x0c | MOD_ALTGR},	// Latin Small Letter I With Tilde
  {0x00f5, 0x12 | MOD_ALTGR},	// Latin Small Letter O With Tilde
  {0x00e3, 0x04 | MOD_ALTGR},	// Latin Small Letter A With Tilde
...
const DeadkeyLookup kbdgn_deadkeys[] PROGMEM = 
{
  ...
  {0x1ebd, 0x0065, 0x30 | MOD_ALTGR},	// ẽ Small E Tilde
  {0x1ebc, 0x0045, 0x30 | MOD_ALTGR},	// Ẽ Capital E Tilde
  ...
  {0x1ef9, 0x0079, 0x30 | MOD_ALTGR},	// ỹ Small Y Tilde
  {0x1ef8, 0x0059, 0x30 | MOD_ALTGR},	// Ỹ Capital Y Tilde
...
KeyboardUTF8 Keyboard_GN(kbdgn, sizeof kbdgn / sizeof kbdgn[0], kbdgn_deadkeys, sizeof kbdgn_deadkeys / sizeof kbdgn_deadkeys[0]);
