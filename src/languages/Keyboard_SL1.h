...
const UnicodeLookup kbdsl1[] PROGMEM = 
{
  ...
  {0x0027, 0x13 | MOD_ALTGR},	// Apostrophe
  ...
  {0x013e, 0x1f},	// Latin Small Letter L With Caron
  {0x0161, 0x20},	// Latin Small Letter S With Caron
  {0x010d, 0x21},	// Latin Small Letter C With Caron
  {0x0165, 0x22},	// Latin Small Letter T With Caron
  ...
  {0x00e4, 0x30},	// Latin Small Letter A With Diaeresis
  {0x0148, 0x31},	// Latin Small Letter N With Caron
  ...
  {0x00f4, 0x33},	// Latin Small Letter O With Circumflex
...
const DeadkeyLookup kbdsl1_deadkeys[] PROGMEM = 
{
...
KeyboardUTF8 Keyboard_SL1(kbdsl1, sizeof kbdsl1 / sizeof kbdsl1[0], kbdsl1_deadkeys, sizeof kbdsl1_deadkeys / sizeof kbdsl1_deadkeys[0]);
