...
const UnicodeLookup kbdhaw[] PROGMEM = 
{
  ...
  {0x02bb, 0x34},	// Modifier Letter Turned Comma
...
KeyboardUTF8 Keyboard_HAW(kbdhaw, sizeof kbdhaw / sizeof kbdhaw[0], kbdhaw_deadkeys, sizeof kbdhaw_deadkeys / sizeof kbdhaw_deadkeys[0]);
