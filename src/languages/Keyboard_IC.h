...
const UnicodeLookup kbdic[] PROGMEM = 
{
  ...
  {0x00b0, 0x35 | MOD_ALTGR},	// Degree Sign
  ...
  {0x00d6, 0x2d | MOD_SHIFT},	// Latin Capital Letter O With Diaeresis
  ...
  {0x00d0, 0x2f | MOD_SHIFT},	// Latin Capital Letter Eth (Icelandic)
  {0x003f, 0x30 | MOD_SHIFT},	// Question Mark
  ...
  {0x00c6, 0x33 | MOD_SHIFT},	// Latin Capital Letter Ae (Ash) *
  {0x0027, 0x30},	// Apostrophe
  {0x002a, 0x28 | MOD_SHIFT},	// Asterisk
  ...
  {0x00de, 0x38 | MOD_SHIFT},	// Latin Capital Letter Thorn (Icelandic)
  ...
  {0x00f6, 0x2d},	// Latin Small Letter O With Diaeresis
  ...
  {0x00f0, 0x2f},	// Latin Small Letter Eth (Icelandic)
  ...
  {0x00e6, 0x33},	// Latin Small Letter Ae (Ash) *
  {0x002b, 0x28},	// Plus Sign
...
const DeadkeyLookup kbdic_deadkeys[] PROGMEM = 
{
  ...
  {0x00a8, 0x00a8, 0x35 | MOD_SHIFT},	// ¨  accent
  {0x00e4, 0x0061, 0x35 | MOD_SHIFT},	// ä Small A Diaeresis
  {0x00c4, 0x0041, 0x35 | MOD_SHIFT},	// Ä Capital A Diaeresis
  {0x00eb, 0x0065, 0x35 | MOD_SHIFT},	// ë Small E Diaeresis
  {0x00cb, 0x0045, 0x35 | MOD_SHIFT},	// Ë Capital E Diaeresis
  {0x00ef, 0x0069, 0x35 | MOD_SHIFT},	// ï Small I Diaeresis
  {0x00cf, 0x0049, 0x35 | MOD_SHIFT},	// Ï Capital I Diaeresis
  {0x00f6, 0x006f, 0x35 | MOD_SHIFT},	// ö Small O Diaeresis
  {0x00d6, 0x004f, 0x35 | MOD_SHIFT},	// Ö Capital O Diaeresis
  {0x00fc, 0x0075, 0x35 | MOD_SHIFT},	// ü Small U Diaeresis
  {0x00dc, 0x0055, 0x35 | MOD_SHIFT},	// Ü Capital U Diaeresis
  {0x00ff, 0x0079, 0x35 | MOD_SHIFT},	// ÿ Small Y Diaeresis
  {0x00b0, 0x00b0, 0x35},	// °  accent
  {0x00e5, 0x0061, 0x35},	// å Small A Ring Above,
  {0x00c5, 0x0041, 0x35},	// Å Capital A Ring Above,
...
KeyboardUTF8 Keyboard_IC(kbdic, sizeof kbdic / sizeof kbdic[0], kbdic_deadkeys, sizeof kbdic_deadkeys / sizeof kbdic_deadkeys[0]);
