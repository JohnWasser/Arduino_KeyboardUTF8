...
const UnicodeLookup kbdnso_2[] PROGMEM = 
{
  ...
  {0x00a8, 0x34 | (MOD_SHIFT | MOD_ALTGR)},	// Diaeresis
  ...
  {0x0160, 0x37 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter S With Caron
  ...
  {0x00ac, 0x31 | MOD_ALTGR},	// Not Sign
  ...
  {0x0161, 0x37 | MOD_ALTGR},	// Latin Small Letter S With Caron
...
const DeadkeyLookup kbdnso_2_deadkeys[] PROGMEM = 
{
  ...
  {0x00e7, 0x0063, 0x34},	// ç Small C Cedilla
  {0x00c7, 0x0043, 0x34},	// Ç Capital C Cedilla
...
KeyboardUTF8 Keyboard_NSO_2(kbdnso_2, sizeof kbdnso_2 / sizeof kbdnso_2[0], kbdnso_2_deadkeys, sizeof kbdnso_2_deadkeys / sizeof kbdnso_2_deadkeys[0]);
