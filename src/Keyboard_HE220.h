...
const UnicodeLookup kbdhe220[] PROGMEM = 
{
  ...
  {0x005b, 0x2e | MOD_SHIFT},	// Left Square Bracket
  {0x003a, 0x37 | MOD_SHIFT},	// Colon
  {0x007e, 0x1a | MOD_SHIFT},	// Tilde
  ...
  {0x037e, 0x14},	// Greek Question Mark (Erotimatiko)
  ...
  {0x007d, 0x30},	// Right Curly Bracket
...
const DeadkeyLookup kbdhe220_deadkeys[] PROGMEM = 
{
  ...
  {0x03b0, 0x03b0, 0x34 | MOD_SHIFT},	// ΰ  accent
  {0x00a8, 0x00a8, 0x34},	// ¨  accent
  {0x03ca, 0x03ca, 0x34},	// ϊ  accent
  {0x03aa, 0x03aa, 0x34},	// Ϊ  accent
  {0x03cb, 0x03cb, 0x34},	// ϋ  accent
  {0x03ab, 0x03ab, 0x34},	// Ϋ  accent
...
KeyboardUTF8 Keyboard_HE220(kbdhe220, sizeof kbdhe220 / sizeof kbdhe220[0], kbdhe220_deadkeys, sizeof kbdhe220_deadkeys / sizeof kbdhe220_deadkeys[0]);
