...
const UnicodeLookup kbdsorst[] PROGMEM = 
{
...
const DeadkeyLookup kbdsorst_deadkeys[] PROGMEM = 
{
  {0x0307, 0x0307, 0x35 | MOD_SHIFT},	// ̇  accent
...
KeyboardUTF8 Keyboard_SORST(kbdsorst, sizeof kbdsorst / sizeof kbdsorst[0], kbdsorst_deadkeys, sizeof kbdsorst_deadkeys / sizeof kbdsorst_deadkeys[0]);
