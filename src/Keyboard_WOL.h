...
const UnicodeLookup kbdwol[] PROGMEM = 
{
  ...
  {0x00c3, 0x35 | MOD_SHIFT},	// Latin Capital Letter A With Tilde
  ...
  {0x00c9, 0x2d | MOD_SHIFT},	// Latin Capital Letter E With Acute
  ...
  {0x00d3, 0x30 | MOD_SHIFT},	// Latin Capital Letter O With Acute
  {0x00d1, 0x31 | MOD_SHIFT},	// Latin Capital Letter N With Tilde
  ...
  {0x00c0, 0x34 | MOD_SHIFT},	// Latin Capital Letter A With Grave
  ...
  {0x014a, 0x38 | MOD_SHIFT},	// Latin Capital Letter Eng (Sami)
  {0x00e3, 0x35},	// Latin Small Letter A With Tilde
  ...
  {0x00f1, 0x24},	// Latin Small Letter N With Tilde
  {0x005f, 0x25},	// Low Line
  {0x014b, 0x26},	// Latin Small Letter Eng (Sami)
  ...
  {0x00f3, 0x30},	// Latin Small Letter O With Acute
  {0x002a, 0x31},	// Asterisk
...
KeyboardUTF8 Keyboard_WOL(kbdwol, sizeof kbdwol / sizeof kbdwol[0], kbdwol_deadkeys, sizeof kbdwol_deadkeys / sizeof kbdwol_deadkeys[0]);
