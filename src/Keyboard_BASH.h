...
const UnicodeLookup kbdbash[] PROGMEM = 
{
  ...
  {0x04d8, 0x35 | MOD_SHIFT},	// Cyrillic Capital Letter Schwa
  {0x0022, 0x1e | MOD_SHIFT},	// Quotation Mark
  {0x04e8, 0x1f | MOD_SHIFT},	// Cyrillic Capital Letter Barred O
  {0x04a0, 0x20 | MOD_SHIFT},	// Cyrillic Capital Letter Bashkir Ka
  {0x0492, 0x21 | MOD_SHIFT},	// Cyrillic Capital Letter Ghe With Stroke
  {0x04aa, 0x22 | MOD_SHIFT},	// Cyrillic Capital Letter Es With Descender
  {0x003b, 0x23 | MOD_SHIFT},	// Semicolon
  {0x0498, 0x24 | MOD_SHIFT},	// Cyrillic Capital Letter Ze With Descender
  {0x04ba, 0x25 | MOD_SHIFT},	// Cyrillic Capital Letter Shha
  {0x0028, 0x26 | MOD_SHIFT},	// Left Parenthesis
  {0x0029, 0x27 | MOD_SHIFT},	// Right Parenthesis
  {0x0025, 0x2d | MOD_SHIFT},	// Percent Sign
  {0x04ae, 0x2e | MOD_SHIFT},	// Cyrillic Capital Letter Straight U
  ...
  {0x04a2, 0x31 | MOD_SHIFT},	// Cyrillic Capital Letter En With Descender
  ...
  {0x04d9, 0x35},	// Cyrillic Small Letter Schwa
  {0x0021, 0x1e},	// Exclamation Mark
  {0x04e9, 0x1f},	// Cyrillic Small Letter Barred O
  {0x04a1, 0x20},	// Cyrillic Small Letter Bashkir Ka
  {0x0493, 0x21},	// Cyrillic Small Letter Ghe With Stroke
  {0x04ab, 0x22},	// Cyrillic Small Letter Es With Descender
  {0x003a, 0x23},	// Colon
  {0x0499, 0x24},	// Cyrillic Small Letter Ze With Descender
  {0x04bb, 0x25},	// Cyrillic Small Letter Shha
  {0x003f, 0x26},	// Question Mark
  {0x2116, 0x27},	// Numero Sign
  {0x002d, 0x2d},	// Hyphen-Minus
  {0x04af, 0x2e},	// Cyrillic Small Letter Straight U
  ...
  {0x04a3, 0x31},	// Cyrillic Small Letter En With Descender
...
KeyboardUTF8 Keyboard_BASH(kbdbash, sizeof kbdbash / sizeof kbdbash[0], kbdbash_deadkeys, sizeof kbdbash_deadkeys / sizeof kbdbash_deadkeys[0]);
