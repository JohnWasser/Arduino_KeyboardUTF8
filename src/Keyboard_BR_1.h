...
const UnicodeLookup kbdbr_1[] PROGMEM = 
{
  ...
  {0x00a2, 0x22 | MOD_ALTGR},	// Cent Sign
  {0x00ac, 0x23 | MOD_ALTGR},	// Not Sign
  {0x00a7, 0x2e | MOD_ALTGR},	// Section Sign
  {0x002f, 0x14 | MOD_ALTGR},	// Solidus
  {0x003f, 0x1a | MOD_ALTGR},	// Question Mark
  {0x00b0, 0x08 | MOD_ALTGR},	// Degree Sign
  {0x00aa, 0x30 | MOD_ALTGR},	// Feminine Ordinal Indicator
  {0x00ba, 0x28 | MOD_ALTGR},	// Masculine Ordinal Indicator
  {0x20a2, 0x06 | MOD_ALTGR},	// Cruzeiro Sign
  {0x0022, 0x35 | MOD_SHIFT},	// Quotation Mark
  ...
  {0x00c7, 0x33 | MOD_SHIFT},	// Latin Capital Letter C With Cedilla
  {0x007d, 0x28 | MOD_SHIFT},	// Right Curly Bracket
  ...
  {0x00e7, 0x33},	// Latin Small Letter C With Cedilla
  {0x005d, 0x28},	// Right Square Bracket
...
const DeadkeyLookup kbdbr_1_deadkeys[] PROGMEM = 
{
  {0x00a8, 0x00a8, 0x23 | MOD_SHIFT},	// ¨  accent
  {0x00e4, 0x0061, 0x23 | MOD_SHIFT},	// ä Small A Diaeresis
  {0x00c4, 0x0041, 0x23 | MOD_SHIFT},	// Ä Capital A Diaeresis
  {0x00eb, 0x0065, 0x23 | MOD_SHIFT},	// ë Small E Diaeresis
  {0x00cb, 0x0045, 0x23 | MOD_SHIFT},	// Ë Capital E Diaeresis
  {0x00ef, 0x0069, 0x23 | MOD_SHIFT},	// ï Small I Diaeresis
  {0x00cf, 0x0049, 0x23 | MOD_SHIFT},	// Ï Capital I Diaeresis
  {0x00f6, 0x006f, 0x23 | MOD_SHIFT},	// ö Small O Diaeresis
  {0x00d6, 0x004f, 0x23 | MOD_SHIFT},	// Ö Capital O Diaeresis
  {0x00fc, 0x0075, 0x23 | MOD_SHIFT},	// ü Small U Diaeresis
  {0x00dc, 0x0055, 0x23 | MOD_SHIFT},	// Ü Capital U Diaeresis
  {0x00ff, 0x0079, 0x23 | MOD_SHIFT},	// ÿ Small Y Diaeresis
  {0x0060, 0x0060, 0x2f | MOD_SHIFT},	// `  accent
  {0x00e0, 0x0061, 0x2f | MOD_SHIFT},	// à Small A Grave
  {0x00c0, 0x0041, 0x2f | MOD_SHIFT},	// À Capital A Grave
  {0x00e8, 0x0065, 0x2f | MOD_SHIFT},	// è Small E Grave
  {0x00c8, 0x0045, 0x2f | MOD_SHIFT},	// È Capital E Grave
  {0x00ec, 0x0069, 0x2f | MOD_SHIFT},	// ì Small I Grave
  {0x00cc, 0x0049, 0x2f | MOD_SHIFT},	// Ì Capital I Grave
  {0x00f2, 0x006f, 0x2f | MOD_SHIFT},	// ò Small O Grave
  {0x00d2, 0x004f, 0x2f | MOD_SHIFT},	// Ò Capital O Grave
  {0x00f9, 0x0075, 0x2f | MOD_SHIFT},	// ù Small U Grave
  {0x00d9, 0x0055, 0x2f | MOD_SHIFT},	// Ù Capital U Grave
  {0x005e, 0x005e, 0x34 | MOD_SHIFT},	// ^  accent
  {0x00e2, 0x0061, 0x34 | MOD_SHIFT},	// â Small A Circumflex
  {0x00c2, 0x0041, 0x34 | MOD_SHIFT},	// Â Capital A Circumflex
  {0x00ea, 0x0065, 0x34 | MOD_SHIFT},	// ê Small E Circumflex
  {0x00ca, 0x0045, 0x34 | MOD_SHIFT},	// Ê Capital E Circumflex
  {0x00ee, 0x0069, 0x34 | MOD_SHIFT},	// î Small I Circumflex
  {0x00ce, 0x0049, 0x34 | MOD_SHIFT},	// Î Capital I Circumflex
  {0x00f4, 0x006f, 0x34 | MOD_SHIFT},	// ô Small O Circumflex
  {0x00d4, 0x004f, 0x34 | MOD_SHIFT},	// Ô Capital O Circumflex
  {0x00fb, 0x0075, 0x34 | MOD_SHIFT},	// û Small U Circumflex
  {0x00db, 0x0055, 0x34 | MOD_SHIFT},	// Û Capital U Circumflex
  ...
  {0x007e, 0x007e, 0x34},	// ~  accent
  {0x00e3, 0x0061, 0x34},	// ã Small A Tilde
  {0x00c3, 0x0041, 0x34},	// Ã Capital A Tilde
  {0x00f1, 0x006e, 0x34},	// ñ Small N Tilde
  {0x00d1, 0x004e, 0x34},	// Ñ Capital N Tilde
  {0x00f5, 0x006f, 0x34},	// õ Small O Tilde
  {0x00d5, 0x004f, 0x34},	// Õ Capital O Tilde
};

KeyboardUTF8 Keyboard_BR_1(kbdbr_1, sizeof kbdbr_1 / sizeof kbdbr_1[0], kbdbr_1_deadkeys, sizeof kbdbr_1_deadkeys / sizeof kbdbr_1_deadkeys[0]);
