...
const UnicodeLookup kbdit142[] PROGMEM = 
{
  ...
  {0x0060, 0x28 | MOD_ALTGR},	// Grave Accent
  ...
  {0x005e, 0x2e | MOD_SHIFT},	// Circumflex Accent
  ...
  {0x00e9, 0x2f | MOD_SHIFT},	// Latin Small Letter E With Acute
  ...
  {0x00e7, 0x33 | MOD_SHIFT},	// Latin Small Letter C With Cedilla
  {0x00b0, 0x34 | MOD_SHIFT},	// Degree Sign
  ...
  {0x00ec, 0x2e},	// Latin Small Letter I With Grave
  ...
  {0x00f2, 0x33},	// Latin Small Letter O With Grave
  {0x00e0, 0x34},	// Latin Small Letter A With Grave
  {0x00f9, 0x28},	// Latin Small Letter U With Grave
...
const DeadkeyLookup kbdit142_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_IT142(kbdit142, sizeof kbdit142 / sizeof kbdit142[0], kbdit142_deadkeys, sizeof kbdit142_deadkeys / sizeof kbdit142_deadkeys[0]);
