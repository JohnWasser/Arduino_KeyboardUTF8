...
const UnicodeLookup kbdda[] PROGMEM = 
{
...
const DeadkeyLookup kbdda_deadkeys[] PROGMEM = 
{
...
KeyboardUTF8 Keyboard_DA(kbdda, sizeof kbdda / sizeof kbdda[0], kbdda_deadkeys, sizeof kbdda_deadkeys / sizeof kbdda_deadkeys[0]);
