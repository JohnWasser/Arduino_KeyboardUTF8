...
const UnicodeLookup kbdus_3[] PROGMEM = 
{
...
const DeadkeyLookup kbdus_3_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_US_3(kbdus_3, sizeof kbdus_3 / sizeof kbdus_3[0], kbdus_3_deadkeys, sizeof kbdus_3_deadkeys / sizeof kbdus_3_deadkeys[0]);
