...
const UnicodeLookup kbdtiprd[] PROGMEM = 
{
  ...
  {0x0f5c, 0x28 | (MOD_SHIFT | MOD_ALTGR)},	// Tibetan Letter Dzha
  ...
  {0x0f1e, 0x28 | MOD_SHIFT},	// Tibetan Sign Rdel Nag Gnyis (Dena Nyi)
  ...
  {0x0f5b, 0x28},	// Tibetan Letter Dza
...
KeyboardUTF8 Keyboard_TIPRD(kbdtiprd, sizeof kbdtiprd / sizeof kbdtiprd[0], kbdtiprd_deadkeys, sizeof kbdtiprd_deadkeys / sizeof kbdtiprd_deadkeys[0]);
