...
const UnicodeLookup kbdhela3[] PROGMEM = 
{
  ...
  {0x0040, 0x28 | MOD_SHIFT},	// Commercial At
...
const DeadkeyLookup kbdhela3_deadkeys[] PROGMEM = 
{
  {0x00a8, 0x00a8, 0x33 | MOD_SHIFT},	// ¨  accent
  {0x00e4, 0x0061, 0x33 | MOD_SHIFT},	// ä Small A Diaeresis
  {0x00c4, 0x0041, 0x33 | MOD_SHIFT},	// Ä Capital A Diaeresis
  {0x00eb, 0x0065, 0x33 | MOD_SHIFT},	// ë Small E Diaeresis
  {0x00cb, 0x0045, 0x33 | MOD_SHIFT},	// Ë Capital E Diaeresis
  {0x00ef, 0x0069, 0x33 | MOD_SHIFT},	// ï Small I Diaeresis
  {0x00cf, 0x0049, 0x33 | MOD_SHIFT},	// Ï Capital I Diaeresis
  {0x00f6, 0x006f, 0x33 | MOD_SHIFT},	// ö Small O Diaeresis
  {0x00d6, 0x004f, 0x33 | MOD_SHIFT},	// Ö Capital O Diaeresis
  {0x00fc, 0x0075, 0x33 | MOD_SHIFT},	// ü Small U Diaeresis
  {0x00dc, 0x0055, 0x33 | MOD_SHIFT},	// Ü Capital U Diaeresis
  {0x00ff, 0x0079, 0x33 | MOD_SHIFT},	// ÿ Small Y Diaeresis
  {0x007e, 0x007e, 0x34 | MOD_SHIFT},	// ~  accent
  {0x00e3, 0x0061, 0x34 | MOD_SHIFT},	// ã Small A Tilde
  {0x00c3, 0x0041, 0x34 | MOD_SHIFT},	// Ã Capital A Tilde
  {0x00f1, 0x006e, 0x34 | MOD_SHIFT},	// ñ Small N Tilde
  {0x00d1, 0x004e, 0x34 | MOD_SHIFT},	// Ñ Capital N Tilde
  {0x00f5, 0x006f, 0x34 | MOD_SHIFT},	// õ Small O Tilde
  {0x00d5, 0x004f, 0x34 | MOD_SHIFT},	// Õ Capital O Tilde
  {0x00b4, 0x00b4, 0x33},	// ´  accent
  {0x00e1, 0x0061, 0x33},	// á Small A Acute
  {0x00c1, 0x0041, 0x33},	// Á Capital A Acute
  {0x00e9, 0x0065, 0x33},	// é Small E Acute
  {0x00c9, 0x0045, 0x33},	// É Capital E Acute
  {0x00ed, 0x0069, 0x33},	// í Small I Acute
  {0x00cd, 0x0049, 0x33},	// Í Capital I Acute
  {0x00f3, 0x006f, 0x33},	// ó Small O Acute
  {0x00d3, 0x004f, 0x33},	// Ó Capital O Acute
  {0x00fa, 0x0075, 0x33},	// ú Small U Acute
  {0x00da, 0x0055, 0x33},	// Ú Capital U Acute
  {0x00fd, 0x0079, 0x33},	// ý Small Y Acute
  {0x00dd, 0x0059, 0x33},	// Ý Capital Y Acute
  {0x005e, 0x005e, 0x34},	// ^  accent
  {0x00e2, 0x0061, 0x34},	// â Small A Circumflex
  {0x00c2, 0x0041, 0x34},	// Â Capital A Circumflex
  {0x00ea, 0x0065, 0x34},	// ê Small E Circumflex
  {0x00ca, 0x0045, 0x34},	// Ê Capital E Circumflex
  {0x00ee, 0x0069, 0x34},	// î Small I Circumflex
  {0x00ce, 0x0049, 0x34},	// Î Capital I Circumflex
  {0x00f4, 0x006f, 0x34},	// ô Small O Circumflex
  {0x00d4, 0x004f, 0x34},	// Ô Capital O Circumflex
  {0x00fb, 0x0075, 0x34},	// û Small U Circumflex
  {0x00db, 0x0055, 0x34},	// Û Capital U Circumflex
  {0x0060, 0x0060, 0x28},	// `  accent
  {0x00e0, 0x0061, 0x28},	// à Small A Grave
  {0x00c0, 0x0041, 0x28},	// À Capital A Grave
  {0x00e8, 0x0065, 0x28},	// è Small E Grave
  {0x00c8, 0x0045, 0x28},	// È Capital E Grave
  {0x00ec, 0x0069, 0x28},	// ì Small I Grave
  {0x00cc, 0x0049, 0x28},	// Ì Capital I Grave
  {0x00f2, 0x006f, 0x28},	// ò Small O Grave
  {0x00d2, 0x004f, 0x28},	// Ò Capital O Grave
  {0x00f9, 0x0075, 0x28},	// ù Small U Grave
  {0x00d9, 0x0055, 0x28},	// Ù Capital U Grave
};

KeyboardUTF8 Keyboard_HELA3(kbdhela3, sizeof kbdhela3 / sizeof kbdhela3[0], kbdhela3_deadkeys, sizeof kbdhela3_deadkeys / sizeof kbdhela3_deadkeys[0]);
