...
const UnicodeLookup kbdinasa[] PROGMEM = 
{
  ...
  {0x09f0, 0x0d},	// Bengali Letter Ra With Middle Diagonal (Assamese)
  ...
  {0x09f1, 0x05},	// Bengali Letter Ra With Lower Diagonal (Assamese)
...
const DeadkeyLookup kbdinasa_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_INASA(kbdinasa, sizeof kbdinasa / sizeof kbdinasa[0], kbdinasa_deadkeys, sizeof kbdinasa_deadkeys / sizeof kbdinasa_deadkeys[0]);
