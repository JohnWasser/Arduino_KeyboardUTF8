...
const UnicodeLookup kbdcz[] PROGMEM = 
{
  ...
  {0x00a4, 0x31 | MOD_ALTGR},	// Currency Sign
...
const DeadkeyLookup kbdcz_deadkeys[] PROGMEM = 
{
  ...
  {0x011f, 0x0067, 0x21 | MOD_ALTGR},	// ğ Small G Breve
  {0x011e, 0x0047, 0x21 | MOD_ALTGR},	// Ğ Capital G Breve
  ...
  {0x012f, 0x0069, 0x23 | MOD_ALTGR},	// į Small I Ogonek
  {0x012e, 0x0049, 0x23 | MOD_ALTGR},	// Į Capital I Ogonek
  {0x0173, 0x0075, 0x23 | MOD_ALTGR},	// ų Small U Ogonek
  {0x0172, 0x0055, 0x23 | MOD_ALTGR},	// Ų Capital U Ogonek
  ...
  {0x0117, 0x0065, 0x25 | MOD_ALTGR},	// ė Small E Dot Above
  {0x0116, 0x0045, 0x25 | MOD_ALTGR},	// Ė Capital E Dot Above
  {0x0131, 0x0131, 0x25 | MOD_ALTGR},	// ı  accent
  {0x0130, 0x0049, 0x25 | MOD_ALTGR},	// İ Capital I Dot Above
  ...
  {0x0123, 0x0067, 0x2e | MOD_ALTGR},	// ģ Small G Cedilla
  {0x0122, 0x0047, 0x2e | MOD_ALTGR},	// Ģ Capital G Cedilla
  {0x0137, 0x006b, 0x2e | MOD_ALTGR},	// ķ Small K Cedilla
  {0x0136, 0x004b, 0x2e | MOD_ALTGR},	// Ķ Capital K Cedilla
  {0x013c, 0x006c, 0x2e | MOD_ALTGR},	// ļ Small L Cedilla
  {0x013b, 0x004c, 0x2e | MOD_ALTGR},	// Ļ Capital L Cedilla
  {0x0146, 0x006e, 0x2e | MOD_ALTGR},	// ņ Small N Cedilla
  {0x0145, 0x004e, 0x2e | MOD_ALTGR},	// Ņ Capital N Cedilla
  {0x0157, 0x0072, 0x2e | MOD_ALTGR},	// ŗ Small R Cedilla
  {0x0156, 0x0052, 0x2e | MOD_ALTGR},	// Ŗ Capital R Cedilla
...
KeyboardUTF8 Keyboard_CZ(kbdcz, sizeof kbdcz / sizeof kbdcz[0], kbdcz_deadkeys, sizeof kbdcz_deadkeys / sizeof kbdcz_deadkeys[0]);
