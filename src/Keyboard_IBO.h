...
const UnicodeLookup kbdibo[] PROGMEM = 
{
  ...
  {0x1ee4, 0xa0 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter U With Dot Below
  {0x1eca, 0x0c | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter I With Dot Below
  {0x1ecc, 0x12 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter O With Dot Below
  {0x00a6, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// Broken Bar
  {0x1e44, 0x11 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter N With Dot Above
  ...
  {0x1ee5, 0xa0 | MOD_ALTGR},	// Latin Small Letter U With Dot Below
  {0x1ecb, 0x0c | MOD_ALTGR},	// Latin Small Letter I With Dot Below
  {0x1ecd, 0x12 | MOD_ALTGR},	// Latin Small Letter O With Dot Below
  {0x00b6, 0x33 | MOD_ALTGR},	// Pilcrow Sign
  {0x00b4, 0x34 | MOD_ALTGR},	// Acute Accent
  {0x1e45, 0x11 | MOD_ALTGR},	// Latin Small Letter N With Dot Above
...
const DeadkeyLookup kbdibo_deadkeys[] PROGMEM = 
{
  ...
  {0x00c1, 0x0041, 0x35 | MOD_SHIFT},	// Á Capital A Acute
  {0x00e9, 0x0065, 0x35 | MOD_SHIFT},	// é Small E Acute
  {0x00c9, 0x0045, 0x35 | MOD_SHIFT},	// É Capital E Acute
  {0x00ed, 0x0069, 0x35 | MOD_SHIFT},	// í Small I Acute
  {0x00cd, 0x0049, 0x35 | MOD_SHIFT},	// Í Capital I Acute
  {0x1e3f, 0x006d, 0x35 | MOD_SHIFT},	// ḿ Small M Acute
  {0x1e3e, 0x004d, 0x35 | MOD_SHIFT},	// Ḿ Capital M Acute
  {0x0144, 0x006e, 0x35 | MOD_SHIFT},	// ń Small N Acute
  {0x0143, 0x004e, 0x35 | MOD_SHIFT},	// Ń Capital N Acute
  {0x00f3, 0x006f, 0x35 | MOD_SHIFT},	// ó Small O Acute
  {0x00d3, 0x004f, 0x35 | MOD_SHIFT},	// Ó Capital O Acute
  {0x00fa, 0x0075, 0x35 | MOD_SHIFT},	// ú Small U Acute
  {0x00da, 0x0055, 0x35 | MOD_SHIFT},	// Ú Capital U Acute
  {0x005e, 0x005e, 0x23 | MOD_SHIFT},	// ^  accent
  {0x0101, 0x0061, 0x23 | MOD_SHIFT},	// ā Small A Macron
  {0x0100, 0x0041, 0x23 | MOD_SHIFT},	// Ā Capital A Macron
  {0x0113, 0x0065, 0x23 | MOD_SHIFT},	// ē Small E Macron
  {0x0112, 0x0045, 0x23 | MOD_SHIFT},	// Ē Capital E Macron
  {0x012b, 0x0069, 0x23 | MOD_SHIFT},	// ī Small I Macron
  {0x012a, 0x0049, 0x23 | MOD_SHIFT},	// Ī Capital I Macron
  {0x014d, 0x006f, 0x23 | MOD_SHIFT},	// ō Small O Macron
  {0x014c, 0x004f, 0x23 | MOD_SHIFT},	// Ō Capital O Macron
  {0x016b, 0x0075, 0x23 | MOD_SHIFT},	// ū Small U Macron
  {0x016a, 0x0055, 0x23 | MOD_SHIFT},	// Ū Capital U Macron
  ...
  {0x01f9, 0x006e, 0x35},	// ǹ Small N Grave
  {0x01f8, 0x004e, 0x35},	// Ǹ Capital N Grave
...
KeyboardUTF8 Keyboard_IBO(kbdibo, sizeof kbdibo / sizeof kbdibo[0], kbdibo_deadkeys, sizeof kbdibo_deadkeys / sizeof kbdibo_deadkeys[0]);
