...
const UnicodeLookup kbdiulat[] PROGMEM = 
{
  ...
  {0x014a, 0x33 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter Eng (Sami)
  ...
  {0x0021, 0x1e | MOD_ALTGR},	// Exclamation Mark
  ...
  {0x002a, 0x23 | MOD_ALTGR},	// Asterisk
...
KeyboardUTF8 Keyboard_IULAT(kbdiulat, sizeof kbdiulat / sizeof kbdiulat[0], kbdiulat_deadkeys, sizeof kbdiulat_deadkeys / sizeof kbdiulat_deadkeys[0]);
