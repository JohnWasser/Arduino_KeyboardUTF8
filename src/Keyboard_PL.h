...
const UnicodeLookup kbdpl[] PROGMEM = 
{
  ...
  {0x00a6, 0x1a | MOD_ALTGR},	// Broken Bar
  ...
  {0x0144, 0x2f | MOD_SHIFT},	// Latin Small Letter N With Acute
  {0x0107, 0x30 | MOD_SHIFT},	// Latin Small Letter C With Acute
  ...
  {0x0141, 0x33 | MOD_SHIFT},	// Latin Capital Letter L With Stroke
  {0x0119, 0x34 | MOD_SHIFT},	// Latin Small Letter E With Ogonek
  {0x017a, 0x28 | MOD_SHIFT},	// Latin Small Letter Z With Acute
  ...
  {0x017c, 0x2f},	// Latin Small Letter Z With Dot Above
  {0x015b, 0x30},	// Latin Small Letter S With Acute
  ...
  {0x0105, 0x34},	// Latin Small Letter A With Ogonek
  {0x00f3, 0x28},	// Latin Small Letter O With Acute
...
const DeadkeyLookup kbdpl_deadkeys[] PROGMEM = 
{
  ...
  {0x02db, 0x02db, 0x35},	// ˛  accent
  {0x0105, 0x0061, 0x35},	// ą Small A Ogonek
  {0x0104, 0x0041, 0x35},	// Ą Capital A Ogonek
  {0x0119, 0x0065, 0x35},	// ę Small E Ogonek
  {0x0118, 0x0045, 0x35},	// Ę Capital E Ogonek
  {0x00b7, 0x00b7, 0x35 | MOD_SHIFT},	// ·  accent
...
KeyboardUTF8 Keyboard_PL(kbdpl, sizeof kbdpl / sizeof kbdpl[0], kbdpl_deadkeys, sizeof kbdpl_deadkeys / sizeof kbdpl_deadkeys[0]);
