...
const UnicodeLookup kbdus_7[] PROGMEM = 
{
...
const DeadkeyLookup kbdus_7_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_US_7(kbdus_7, sizeof kbdus_7 / sizeof kbdus_7[0], kbdus_7_deadkeys, sizeof kbdus_7_deadkeys / sizeof kbdus_7_deadkeys[0]);
