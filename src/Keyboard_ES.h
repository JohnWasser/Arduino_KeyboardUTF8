...
const UnicodeLookup kbdes[] PROGMEM = 
{
  ...
  {0x005c, 0x27 | MOD_ALTGR},	// Reverse Solidus
  {0x007c, 0x0b | MOD_ALTGR},	// Vertical Line
  {0x0040, 0x07 | MOD_ALTGR},	// Commercial At
  {0x0023, 0x25 | MOD_ALTGR},	// Number Sign
  ...
  {0x005f, 0x24 | MOD_ALTGR},	// Low Line
  {0x00a7, 0x26 | MOD_ALTGR},	// Section Sign
  {0x002a, 0x2d | MOD_ALTGR},	// Asterisk
  {0x20ac, 0x08 | MOD_ALTGR},	// Euro Sign
  {0x005b, 0x09 | MOD_ALTGR},	// Left Square Bracket
  {0x005d, 0x0a | MOD_ALTGR},	// Right Square Bracket
  {0x0024, 0x04 | MOD_ALTGR},	// Dollar Sign
  {0x0026, 0x16 | MOD_ALTGR},	// Ampersand
  {0x00a3, 0x0d | MOD_ALTGR},	// Pound Sign
  {0x00b1, 0x0e | MOD_ALTGR},	// Plus-Minus Sign
  {0x007e, 0x33 | MOD_ALTGR},	// Tilde
  {0x007b, 0x34 | MOD_ALTGR},	// Left Curly Bracket
  {0x007d, 0x28 | MOD_ALTGR},	// Right Curly Bracket
  {0x00b7, 0x35 | MOD_SHIFT},	// Middle Dot
  {0x00aa, 0x1e | MOD_SHIFT},	// Feminine Ordinal Indicator
  {0x0022, 0x1f | MOD_SHIFT},	// Quotation Mark
  {0x002f, 0x20 | MOD_SHIFT},	// Solidus
  {0x0028, 0x21 | MOD_SHIFT},	// Left Parenthesis
  {0x0029, 0x22 | MOD_SHIFT},	// Right Parenthesis
  {0x00a1, 0x23 | MOD_SHIFT},	// Inverted Exclamation Mark
  {0x0021, 0x24 | MOD_SHIFT},	// Exclamation Mark
  {0x00bf, 0x25 | MOD_SHIFT},	// Inverted Question Mark
  {0x003f, 0x26 | MOD_SHIFT},	// Question Mark
  {0x20a7, 0x27 | MOD_SHIFT},	// Peseta Sign
  ...
  {0x00d7, 0x2f | MOD_SHIFT},	// Multiplication Sign
  ...
  {0x00c7, 0x34 | MOD_SHIFT},	// Latin Capital Letter C With Cedilla
  ...
  {0x0025, 0x38 | MOD_SHIFT},	// Percent Sign
  {0x0027, 0x35},	// Apostrophe
  ...
  {0x00e7, 0x34},	// Latin Small Letter C With Cedilla
...
const DeadkeyLookup kbdes_deadkeys[] PROGMEM = 
{
  ...
  {0x005e, 0x005e, 0x37 | MOD_ALTGR},	// ^  accent
  {0x00e2, 0x0061, 0x37 | MOD_ALTGR},	// â Small A Circumflex
  {0x00c2, 0x0041, 0x37 | MOD_ALTGR},	// Â Capital A Circumflex
  {0x00ea, 0x0065, 0x37 | MOD_ALTGR},	// ê Small E Circumflex
  {0x00ca, 0x0045, 0x37 | MOD_ALTGR},	// Ê Capital E Circumflex
  {0x00ee, 0x0069, 0x37 | MOD_ALTGR},	// î Small I Circumflex
  {0x00ce, 0x0049, 0x37 | MOD_ALTGR},	// Î Capital I Circumflex
  {0x00f4, 0x006f, 0x37 | MOD_ALTGR},	// ô Small O Circumflex
  {0x00d4, 0x004f, 0x37 | MOD_ALTGR},	// Ô Capital O Circumflex
  {0x00fb, 0x0075, 0x37 | MOD_ALTGR},	// û Small U Circumflex
  {0x00db, 0x0055, 0x37 | MOD_ALTGR},	// Û Capital U Circumflex
  {0x00a8, 0x00a8, 0x2e},	// ¨  accent
  {0x00e4, 0x0061, 0x2e},	// ä Small A Diaeresis
  {0x00c4, 0x0041, 0x2e},	// Ä Capital A Diaeresis
  {0x00eb, 0x0065, 0x2e},	// ë Small E Diaeresis
  {0x00cb, 0x0045, 0x2e},	// Ë Capital E Diaeresis
  {0x00ef, 0x0069, 0x2e},	// ï Small I Diaeresis
  {0x00cf, 0x0049, 0x2e},	// Ï Capital I Diaeresis
  {0x00f6, 0x006f, 0x2e},	// ö Small O Diaeresis
  {0x00d6, 0x004f, 0x2e},	// Ö Capital O Diaeresis
  {0x00fc, 0x0075, 0x2e},	// ü Small U Diaeresis
  {0x00dc, 0x0055, 0x2e},	// Ü Capital U Diaeresis
  {0x00ff, 0x0079, 0x2e},	// ÿ Small Y Diaeresis
  {0x0060, 0x0060, 0x30},	// `  accent
  {0x00e0, 0x0061, 0x30},	// à Small A Grave
  {0x00c0, 0x0041, 0x30},	// À Capital A Grave
  {0x00e8, 0x0065, 0x30},	// è Small E Grave
  {0x00c8, 0x0045, 0x30},	// È Capital E Grave
  {0x00ec, 0x0069, 0x30},	// ì Small I Grave
  {0x00cc, 0x0049, 0x30},	// Ì Capital I Grave
  {0x00f2, 0x006f, 0x30},	// ò Small O Grave
  {0x00d2, 0x004f, 0x30},	// Ò Capital O Grave
  {0x00f9, 0x0075, 0x30},	// ù Small U Grave
  {0x00d9, 0x0055, 0x30},	// Ù Capital U Grave
  {0x00b4, 0x00b4, 0x28},	// ´  accent
  {0x00e1, 0x0061, 0x28},	// á Small A Acute
  {0x00c1, 0x0041, 0x28},	// Á Capital A Acute
  {0x00e9, 0x0065, 0x28},	// é Small E Acute
  {0x00c9, 0x0045, 0x28},	// É Capital E Acute
  {0x00ed, 0x0069, 0x28},	// í Small I Acute
  {0x00cd, 0x0049, 0x28},	// Í Capital I Acute
  {0x00f3, 0x006f, 0x28},	// ó Small O Acute
  {0x00d3, 0x004f, 0x28},	// Ó Capital O Acute
  {0x00fa, 0x0075, 0x28},	// ú Small U Acute
  {0x00da, 0x0055, 0x28},	// Ú Capital U Acute
  {0x00fd, 0x0079, 0x28},	// ý Small Y Acute
};

KeyboardUTF8 Keyboard_ES(kbdes, sizeof kbdes / sizeof kbdes[0], kbdes_deadkeys, sizeof kbdes_deadkeys / sizeof kbdes_deadkeys[0]);
