...
const UnicodeLookup kbdcz2[] PROGMEM = 
{
  ...
  {0x011b, 0x1f | MOD_ALTGR},	// Latin Small Letter E With Caron
  {0x0161, 0x20 | MOD_ALTGR},	// Latin Small Letter S With Caron
  {0x010d, 0x21 | MOD_ALTGR},	// Latin Small Letter C With Caron
  {0x0159, 0x22 | MOD_ALTGR},	// Latin Small Letter R With Caron
  {0x017e, 0x23 | MOD_ALTGR},	// Latin Small Letter Z With Caron
  {0x00fd, 0x24 | MOD_ALTGR},	// Latin Small Letter Y With Acute
  {0x00e1, 0x25 | MOD_ALTGR},	// Latin Small Letter A With Acute
  {0x00ed, 0x26 | MOD_ALTGR},	// Latin Small Letter I With Acute
  {0x00e9, 0x27 | MOD_ALTGR},	// Latin Small Letter E With Acute
  {0x003d, 0x2e},	// Equals Sign
  {0x20ac, 0x08 | MOD_ALTGR},	// Euro Sign
  {0x00fa, 0x2f | MOD_ALTGR},	// Latin Small Letter U With Acute
  {0x0029, 0x27 | MOD_SHIFT},	// Right Parenthesis
  {0x016f, 0x33 | MOD_ALTGR},	// Latin Small Letter U With Ring Above
  {0x00a7, 0x34 | MOD_ALTGR},	// Section Sign
...
const DeadkeyLookup kbdcz2_deadkeys[] PROGMEM = 
{
  ...
  {0x00c5, 0x0041, 0x35 | (MOD_SHIFT | MOD_ALTGR)},	// Å Capital A Ring Above,
  {0x016f, 0x0075, 0x35 | (MOD_SHIFT | MOD_ALTGR)},	// ů Small U Ring Above
  {0x016e, 0x0055, 0x35 | (MOD_SHIFT | MOD_ALTGR)},	// Ů Capital U Ring Above,
  {0x02c7, 0x02c7, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// ˇ  accent
  {0x010d, 0x0063, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// č Small C Caron
  {0x010c, 0x0043, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// Č Capital C Caron
  {0x010f, 0x0064, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// ď Small D Caron
  {0x010e, 0x0044, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// Ď Capital D Caron
  {0x011b, 0x0065, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// ě Small E Caron
  {0x011a, 0x0045, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// Ě Capital E Caron
  {0x013e, 0x006c, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// ľ Small L Caron
  {0x013d, 0x004c, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// Ľ Capital L Caron
  {0x0148, 0x006e, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// ň Small N Caron
  {0x0147, 0x004e, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// Ň Capital N Caron
  {0x0159, 0x0072, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// ř Small R Caron
  {0x0158, 0x0052, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// Ř Capital R Caron
  {0x0161, 0x0073, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// š Small S Caron
  {0x0160, 0x0053, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// Š Capital S Caron
  {0x0165, 0x0074, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// ť Small T Caron
  {0x0164, 0x0054, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// Ť Capital T Caron
  {0x017e, 0x007a, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// ž Small Z Caron
  {0x017d, 0x005a, 0x2e | (MOD_SHIFT | MOD_ALTGR)},	// Ž Capital Z Caron
  {0x005e, 0x005e, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// ^  accent
  {0x00e2, 0x0061, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// â Small A Circumflex
  {0x00c2, 0x0041, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// Â Capital A Circumflex
  {0x00ea, 0x0065, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// ê Small E Circumflex
  {0x00ca, 0x0045, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// Ê Capital E Circumflex
  {0x00ee, 0x0069, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// î Small I Circumflex
  {0x00ce, 0x0049, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// Î Capital I Circumflex
  {0x00f4, 0x006f, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// ô Small O Circumflex
  {0x00d4, 0x004f, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// Ô Capital O Circumflex
  {0x00fb, 0x0075, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// û Small U Circumflex
  {0x00db, 0x0055, 0x31 | (MOD_SHIFT | MOD_ALTGR)},	// Û Capital U Circumflex
  ...
  {0x00a8, 0x00a8, 0x31 | MOD_ALTGR},	// ¨  accent
  {0x00e4, 0x0061, 0x31 | MOD_ALTGR},	// ä Small A Diaeresis
  {0x00c4, 0x0041, 0x31 | MOD_ALTGR},	// Ä Capital A Diaeresis
  {0x00eb, 0x0065, 0x31 | MOD_ALTGR},	// ë Small E Diaeresis
  {0x00cb, 0x0045, 0x31 | MOD_ALTGR},	// Ë Capital E Diaeresis
  {0x00ef, 0x0069, 0x31 | MOD_ALTGR},	// ï Small I Diaeresis
  {0x00cf, 0x0049, 0x31 | MOD_ALTGR},	// Ï Capital I Diaeresis
  {0x00f6, 0x006f, 0x31 | MOD_ALTGR},	// ö Small O Diaeresis
  {0x00d6, 0x004f, 0x31 | MOD_ALTGR},	// Ö Capital O Diaeresis
  {0x00fc, 0x0075, 0x31 | MOD_ALTGR},	// ü Small U Diaeresis
  {0x00dc, 0x0055, 0x31 | MOD_ALTGR},	// Ü Capital U Diaeresis
  {0x00ff, 0x0079, 0x31 | MOD_ALTGR},	// ÿ Small Y Diaeresis
  {0x0178, 0x0059, 0x31 | MOD_ALTGR},	// Ÿ Capital Y Diaeresis
};

KeyboardUTF8 Keyboard_CZ2(kbdcz2, sizeof kbdcz2 / sizeof kbdcz2[0], kbdcz2_deadkeys, sizeof kbdcz2_deadkeys / sizeof kbdcz2_deadkeys[0]);
