...
const UnicodeLookup kbdur1[] PROGMEM = 
{
  ...
  {0x20b4, 0x35 | MOD_SHIFT},	// Hryvnia Sign
  ...
  {0x0407, 0x30 | MOD_SHIFT},	// Cyrillic Capital Letter Yi (Ukrainian)
  {0x002f, 0x31 | MOD_SHIFT},	// Solidus
  {0x0424, 0x04 | MOD_SHIFT},	// Cyrillic Capital Letter Ef
  {0x0406, 0x16 | MOD_SHIFT},	// Cyrillic Capital Letter Byelorussian-Ukrainian I
  ...
  {0x0404, 0x34 | MOD_SHIFT},	// Cyrillic Capital Letter Ukrainian Ie
  ...
  {0x0457, 0x30},	// Cyrillic Small Letter Yi (Ukrainian)
  {0x005c, 0x31},	// Reverse Solidus
  {0x0444, 0x04},	// Cyrillic Small Letter Ef
  {0x0456, 0x16},	// Cyrillic Small Letter Byelorussian-Ukrainian I
  ...
  {0x0454, 0x34},	// Cyrillic Small Letter Ukrainian Ie
...
const DeadkeyLookup kbdur1_deadkeys[] PROGMEM = 
{
};

KeyboardUTF8 Keyboard_UR1(kbdur1, sizeof kbdur1 / sizeof kbdur1[0], kbdur1_deadkeys, sizeof kbdur1_deadkeys / sizeof kbdur1_deadkeys[0]);
