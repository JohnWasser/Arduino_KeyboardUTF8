...
const UnicodeLookup kbdit[] PROGMEM = 
{
  ...
  {0x0040, 0x33 | MOD_ALTGR},	// Commercial At
  {0x0023, 0x34 | MOD_ALTGR},	// Number Sign
...
KeyboardUTF8 Keyboard_IT(kbdit, sizeof kbdit / sizeof kbdit[0], kbdit_deadkeys, sizeof kbdit_deadkeys / sizeof kbdit_deadkeys[0]);
