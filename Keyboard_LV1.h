...
const UnicodeLookup kbdlv1[] PROGMEM = 
{
...
const DeadkeyLookup kbdlv1_deadkeys[] PROGMEM = 
{
  ...
  {0x0107, 0x0063, 0x34 | MOD_ALTGR},	// ć Small C Acute
  {0x0106, 0x0043, 0x34 | MOD_ALTGR},	// Ć Capital C Acute
  {0x00e9, 0x0065, 0x34 | MOD_ALTGR},	// é Small E Acute
  {0x00c9, 0x0045, 0x34 | MOD_ALTGR},	// É Capital E Acute
  {0x0144, 0x006e, 0x34 | MOD_ALTGR},	// ń Small N Acute
  {0x0143, 0x004e, 0x34 | MOD_ALTGR},	// Ń Capital N Acute
  {0x00f3, 0x006f, 0x34 | MOD_ALTGR},	// ó Small O Acute
  {0x00d3, 0x004f, 0x34 | MOD_ALTGR},	// Ó Capital O Acute
  {0x015b, 0x0073, 0x34 | MOD_ALTGR},	// ś Small S Acute
  {0x015a, 0x0053, 0x34 | MOD_ALTGR},	// Ś Capital S Acute
  {0x017a, 0x007a, 0x34 | MOD_ALTGR},	// ź Small Z Acute
  {0x0179, 0x005a, 0x34 | MOD_ALTGR},	// Ź Capital Z Acute
  ...
  {0x00b0, 0x00b0, 0x31},	// °  accent
  {0x00e5, 0x0061, 0x31},	// å Small A Ring Above,
  {0x00c5, 0x0041, 0x31},	// Å Capital A Ring Above,
  {0x0117, 0x0065, 0x31},	// ė Small E Dot Above
  {0x0116, 0x0045, 0x31},	// Ė Capital E Dot Above
  {0x0121, 0x0067, 0x31},	// ġ Small G Dot Above
  {0x017c, 0x007a, 0x31},	// ż Small Z Dot Above
  {0x017b, 0x005a, 0x31},	// Ż Capital Z Dot Above
};

KeyboardUTF8 Keyboard_LV1(kbdlv1, sizeof kbdlv1 / sizeof kbdlv1[0], kbdlv1_deadkeys, sizeof kbdlv1_deadkeys / sizeof kbdlv1_deadkeys[0]);
