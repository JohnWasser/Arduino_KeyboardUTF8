...
const DeadkeyLookup kbdmaori_deadkeys[] PROGMEM = 
{
  ...
  {0x0101, 0x0061, 0x35},	// ā Small A Macron
  {0x0100, 0x0041, 0x35},	// Ā Capital A Macron
  {0x0113, 0x0065, 0x35},	// ē Small E Macron
  {0x0112, 0x0045, 0x35},	// Ē Capital E Macron
  {0x012b, 0x0069, 0x35},	// ī Small I Macron
  {0x012a, 0x0049, 0x35},	// Ī Capital I Macron
  {0x014d, 0x006f, 0x35},	// ō Small O Macron
  {0x014c, 0x004f, 0x35},	// Ō Capital O Macron
  {0x016b, 0x0075, 0x35},	// ū Small U Macron
  {0x016a, 0x0055, 0x35},	// Ū Capital U Macron
};

KeyboardUTF8 Keyboard_MAORI(kbdmaori, sizeof kbdmaori / sizeof kbdmaori[0], kbdmaori_deadkeys, sizeof kbdmaori_deadkeys / sizeof kbdmaori_deadkeys[0]);
