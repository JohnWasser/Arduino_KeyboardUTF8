...
const UnicodeLookup kbdlt1[] PROGMEM = 
{
  ...
  {0x0104, 0x1e | MOD_SHIFT},	// Latin Capital Letter A With Ogonek
  {0x010c, 0x1f | MOD_SHIFT},	// Latin Capital Letter C With Caron
  {0x0118, 0x20 | MOD_SHIFT},	// Latin Capital Letter E With Ogonek
  {0x0116, 0x21 | MOD_SHIFT},	// Latin Capital Letter E With Dot Above
  {0x012e, 0x22 | MOD_SHIFT},	// Latin Capital Letter I With Ogonek
  {0x0160, 0x23 | MOD_SHIFT},	// Latin Capital Letter S With Caron
  {0x0172, 0x24 | MOD_SHIFT},	// Latin Capital Letter U With Ogonek
  {0x016a, 0x25 | MOD_SHIFT},	// Latin Capital Letter U With Macron
  {0x0028, 0x26 | MOD_SHIFT},	// Left Parenthesis
  {0x0029, 0x27 | MOD_SHIFT},	// Right Parenthesis
  {0x005f, 0x2d | MOD_SHIFT},	// Low Line
  {0x017d, 0x2e | MOD_SHIFT},	// Latin Capital Letter Z With Caron
  ...
  {0x0105, 0x1e},	// Latin Small Letter A With Ogonek
  {0x010d, 0x1f},	// Latin Small Letter C With Caron
  {0x0119, 0x20},	// Latin Small Letter E With Ogonek
  {0x0117, 0x21},	// Latin Small Letter E With Dot Above
  {0x012f, 0x22},	// Latin Small Letter I With Ogonek
  {0x0161, 0x23},	// Latin Small Letter S With Caron
  {0x0173, 0x24},	// Latin Small Letter U With Ogonek
  {0x016b, 0x25},	// Latin Small Letter U With Macron
  {0x002d, 0x2d},	// Hyphen-Minus
  {0x017e, 0x2e},	// Latin Small Letter Z With Caron
...
KeyboardUTF8 Keyboard_LT1(kbdlt1, sizeof kbdlt1 / sizeof kbdlt1[0], kbdlt1_deadkeys, sizeof kbdlt1_deadkeys / sizeof kbdlt1_deadkeys[0]);
