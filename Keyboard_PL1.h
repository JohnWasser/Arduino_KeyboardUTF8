...
const UnicodeLookup kbdpl1[] PROGMEM = 
{
  ...
  {0x0118, 0x08 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter E With Ogonek
  {0x00d3, 0x12 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter O With Acute
  {0x0104, 0x04 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter A With Ogonek
  {0x015a, 0x16 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter S With Acute
  {0x0141, 0x0f | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter L With Stroke
  {0x017b, 0x1d | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter Z With Dot Above
  {0x0179, 0x1b | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter Z With Acute
  {0x0106, 0x06 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter C With Acute
  {0x0143, 0x11 | (MOD_SHIFT | MOD_ALTGR)},	// Latin Capital Letter N With Acute
  {0x0119, 0x08 | MOD_ALTGR},	// Latin Small Letter E With Ogonek
  {0x20ac, 0xa0 | MOD_ALTGR},	// Euro Sign
  {0x00f3, 0x12 | MOD_ALTGR},	// Latin Small Letter O With Acute
  {0x0105, 0x04 | MOD_ALTGR},	// Latin Small Letter A With Ogonek
  {0x015b, 0x16 | MOD_ALTGR},	// Latin Small Letter S With Acute
  {0x0142, 0x0f | MOD_ALTGR},	// Latin Small Letter L With Stroke
  {0x017c, 0x1d | MOD_ALTGR},	// Latin Small Letter Z With Dot Above
  {0x017a, 0x1b | MOD_ALTGR},	// Latin Small Letter Z With Acute
  {0x0107, 0x06 | MOD_ALTGR},	// Latin Small Letter C With Acute
  {0x0144, 0x11 | MOD_ALTGR},	// Latin Small Letter N With Acute
...
const DeadkeyLookup kbdpl1_deadkeys[] PROGMEM = 
{
  ...
  {0x0104, 0x0041, 0x35 | MOD_SHIFT},	// Ą Capital A Ogonek
  {0x0107, 0x0063, 0x35 | MOD_SHIFT},	// ć Small C Acute
  {0x0106, 0x0043, 0x35 | MOD_SHIFT},	// Ć Capital C Acute
  {0x0119, 0x0065, 0x35 | MOD_SHIFT},	// ę Small E Ogonek
  {0x0118, 0x0045, 0x35 | MOD_SHIFT},	// Ę Capital E Ogonek
  {0x0142, 0x006c, 0x35 | MOD_SHIFT},	// ł Small L Stroke
  {0x0141, 0x004c, 0x35 | MOD_SHIFT},	// Ł Capital L Stroke
  ...
  {0x015b, 0x0073, 0x35 | MOD_SHIFT},	// ś Small S Acute
  {0x015a, 0x0053, 0x35 | MOD_SHIFT},	// Ś Capital S Acute
  {0x017a, 0x007a, 0x35 | MOD_SHIFT},	// ź Small Z Acute
  {0x0179, 0x005a, 0x35 | MOD_SHIFT},	// Ź Capital Z Acute
  {0x017c, 0x007a, 0x35 | MOD_SHIFT},	// ż Small Z Dot Above
  {0x017b, 0x005a, 0x35 | MOD_SHIFT},	// Ż Capital Z Dot Above
};

KeyboardUTF8 Keyboard_PL1(kbdpl1, sizeof kbdpl1 / sizeof kbdpl1[0], kbdpl1_deadkeys, sizeof kbdpl1_deadkeys / sizeof kbdpl1_deadkeys[0]);
