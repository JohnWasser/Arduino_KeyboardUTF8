...
const UnicodeLookup kbdru1[] PROGMEM = 
{
  ...
  {0x003d, 0x2d | MOD_SHIFT},	// Equals Sign
  {0x005c, 0x2e | MOD_SHIFT},	// Reverse Solidus
  ...
  {0x0028, 0x64 | MOD_SHIFT},	// Left Parenthesis
  ...
  {0x0401, 0x38 | MOD_SHIFT},	// Cyrillic Capital Letter Io
  {0x007c, 0x35},	// Vertical Line
  {0x2116, 0x1e},	// Numero Sign
  {0x002d, 0x1f},	// Hyphen-Minus
  {0x002f, 0x20},	// Solidus
  {0x0022, 0x21},	// Quotation Mark
  {0x003a, 0x22},	// Colon
  {0x002c, 0x23},	// Comma
  {0x002e, 0x24},	// Full Stop
  {0x005f, 0x25},	// Low Line
  {0x003f, 0x26},	// Question Mark
  {0x0025, 0x27},	// Percent Sign
  {0x0021, 0x2d},	// Exclamation Mark
  {0x003b, 0x2e},	// Semicolon
...
KeyboardUTF8 Keyboard_RU1(kbdru1, sizeof kbdru1 / sizeof kbdru1[0], kbdru1_deadkeys, sizeof kbdru1_deadkeys / sizeof kbdru1_deadkeys[0]);
